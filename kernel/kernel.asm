...
0000000080000000 <_entry>:
    ...
    80000004:	21013103          	ld	sp,528(sp) # 8000a210 <_GLOBAL_OFFSET_TABLE_+0x8>
...
0000000080000060 <start>:
{
  ...
  x &= ~MSTATUS_MPP_MASK;
    ...
    8000006e:	7ff70713          	addi	a4,a4,2047 # ffffffffffffe7ff <end+0xffffffff7ffdb25f>
...
consoleread(int user_dst, uint64 dst, int n)
{
  ...
  acquire(&cons.lock);
    ...
    80000158:	11c50513          	addi	a0,a0,284 # 80012270 <cons>
  ...
  while(n > 0){
    ...
    80000164:	11048493          	addi	s1,s1,272 # 80012270 <cons>
      if(killed(myproc())){
        release(&cons.lock);
        return -1;
      }
    ...
    8000016c:	1a090913          	addi	s2,s2,416 # 80012308 <cons+0x98>
  while(n > 0){
    ...
    800001a4:	0d070713          	addi	a4,a4,208 # 80012270 <cons>
    ...
    800001ee:	08650513          	addi	a0,a0,134 # 80012270 <cons>
  ...
  return target - n;
    ...
    80000218:	0ef72a23          	sw	a5,244(a4) # 80012308 <cons+0x98>
  ...
  release(&cons.lock);
    ...
    8000022e:	04650513          	addi	a0,a0,70 # 80012270 <cons>
...
consoleintr(int c)
{
  ...
  acquire(&cons.lock);
    ...
    80000282:	ff250513          	addi	a0,a0,-14 # 80012270 <cons>
  ...
  release(&cons.lock);
    ...
    800002a8:	fcc50513          	addi	a0,a0,-52 # 80012270 <cons>
  ...
  switch(c){
    ...
    800002c6:	fae70713          	addi	a4,a4,-82 # 80012270 <cons>
    ...
    800002ec:	f8878793          	addi	a5,a5,-120 # 80012270 <cons>
    ...
    8000031a:	ff27a783          	lw	a5,-14(a5) # 80012308 <cons+0x98>
    ...
    80000330:	f4470713          	addi	a4,a4,-188 # 80012270 <cons>
    80000334:	0a072783          	lw	a5,160(a4)
    80000338:	09c72703          	lw	a4,156(a4)
          cons.buf[(cons.e-1) % INPUT_BUF_SIZE] != '\n'){
    8000033c:	00012497          	auipc	s1,0x12
    80000340:	f3448493          	addi	s1,s1,-204 # 80012270 <cons>
    while(cons.e != cons.w &&
    ...
    80000382:	ef270713          	addi	a4,a4,-270 # 80012270 <cons>
    ...
    80000398:	f6f72e23          	sw	a5,-132(a4) # 80012310 <cons+0xa0>
      consputc(BACKSPACE);
    ...
    800003b6:	ebe78793          	addi	a5,a5,-322 # 80012270 <cons>
    ...
    800003da:	f2c7ab23          	sw	a2,-202(a5) # 8001230c <cons+0x9c>
        wakeup(&cons.r);
    800003de:	00012517          	auipc	a0,0x12
    800003e2:	f2a50513          	addi	a0,a0,-214 # 80012308 <cons+0x98>
...
consoleinit(void)
{
  ...
  initlock(&cons.lock, "cons");
    ...
    80000400:	e7450513          	addi	a0,a0,-396 # 80012270 <cons>
  ...
  devsw[CONSOLE].read = consoleread;
    ...
    80000410:	ffc78793          	addi	a5,a5,-4 # 80022408 <devsw>
...
printint(long long xx, int base, int sign)
{
  ...
  do {
    ...
    8000044a:	34a60613          	addi	a2,a2,842 # 80007790 <digits>
...
printf(char *fmt, ...)
{
  ...
  locking = pr.locking;
    ...
    800004e4:	e507a783          	lw	a5,-432(a5) # 80012330 <pr+0x18>
  ...
  for(i = 0; (cx = fmt[i] & 0xff) != 0; i++){
    ...
    80000530:	dec50513          	addi	a0,a0,-532 # 80012318 <pr>
  ...
  consputc('x');
    ...
    800006f0:	0a4b8b93          	addi	s7,s7,164 # 80007790 <digits>
  ...
  return 0;
    ...
    8000078a:	b9250513          	addi	a0,a0,-1134 # 80012318 <pr>
...
panic(char *s)
{
  ...
  pr.locking = 0;
    ...
    800007a4:	b807a823          	sw	zero,-1136(a5) # 80012330 <pr+0x18>
  printf("panic: ");
  ...
  panicked = 1; // freeze uart output from other CPUs
    ...
    800007c8:	a6f72623          	sw	a5,-1428(a4) # 8000a230 <panicked>
  for(;;)
...
printfinit(void)
{
  ...
  initlock(&pr.lock, "pr");
    ...
    800007dc:	b4048493          	addi	s1,s1,-1216 # 80012318 <pr>
...
uartinit(void)
{
  ...
  initlock(&uart_tx_lock, "uart");
    ...
    80000844:	af850513          	addi	a0,a0,-1288 # 80012338 <uart_tx_lock>
...
uartputc_sync(int c)
{
  ...
  if(panicked){
    ...
    80000868:	9cc7a783          	lw	a5,-1588(a5) # 8000a230 <panicked>
...
uartstart()
{
  while(1){
    ...
    8000089e:	99e7b783          	ld	a5,-1634(a5) # 8000a238 <uart_tx_r>
    800008a2:	0000a717          	auipc	a4,0xa
    800008a6:	99e73703          	ld	a4,-1634(a4) # 8000a240 <uart_tx_w>
    800008aa:	08f70263          	beq	a4,a5,8000092e <uartstart+0x94>
{
    ...
    800008cc:	a70a8a93          	addi	s5,s5,-1424 # 80012338 <uart_tx_lock>
    uart_tx_r += 1;
    800008d0:	0000a497          	auipc	s1,0xa
    800008d4:	96848493          	addi	s1,s1,-1688 # 8000a238 <uart_tx_r>
    ...
    800008e0:	96498993          	addi	s3,s3,-1692 # 8000a240 <uart_tx_w>
    if((ReadReg(LSR) & LSR_TX_IDLE) == 0){
...
000000008000093a <uartputc>:
{
  ...
  acquire(&uart_tx_lock);
    ...
    80000950:	9ec50513          	addi	a0,a0,-1556 # 80012338 <uart_tx_lock>
    80000954:	2a0000ef          	jal	80000bf4 <acquire>
  if(panicked){
    80000958:	0000a797          	auipc	a5,0xa
    8000095c:	8d87a783          	lw	a5,-1832(a5) # 8000a230 <panicked>
    80000960:	efbd                	bnez	a5,800009de <uartputc+0xa4>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80000962:	0000a717          	auipc	a4,0xa
    80000966:	8de73703          	ld	a4,-1826(a4) # 8000a240 <uart_tx_w>
    8000096a:	0000a797          	auipc	a5,0xa
    8000096e:	8ce7b783          	ld	a5,-1842(a5) # 8000a238 <uart_tx_r>
    80000972:	02078793          	addi	a5,a5,32
    sleep(&uart_tx_r, &uart_tx_lock);
    80000976:	00012997          	auipc	s3,0x12
    8000097a:	9c298993          	addi	s3,s3,-1598 # 80012338 <uart_tx_lock>
    8000097e:	0000a497          	auipc	s1,0xa
    80000982:	8ba48493          	addi	s1,s1,-1862 # 8000a238 <uart_tx_r>
  while(uart_tx_w == uart_tx_r + UART_TX_BUF_SIZE){
    80000986:	0000a917          	auipc	s2,0xa
    8000098a:	8ba90913          	addi	s2,s2,-1862 # 8000a240 <uart_tx_w>
  ...
  uart_tx_buf[uart_tx_w % UART_TX_BUF_SIZE] = c;
    ...
    800009ac:	99048493          	addi	s1,s1,-1648 # 80012338 <uart_tx_lock>
  ...
  uart_tx_w += 1;
    ...
    800009c0:	88e7b223          	sd	a4,-1916(a5) # 8000a240 <uart_tx_w>
  uartstart();
...
uartintr(void)
{
  ...
  acquire(&uart_tx_lock);
    ...
    80000a24:	91848493          	addi	s1,s1,-1768 # 80012338 <uart_tx_lock>
...
kfree(void *pa)
{
  ...
  if(((uint64)pa % PGSIZE) != 0 || (char*)pa < end || (uint64)pa >= PHYSTOP)
    ...
    80000a5a:	b4a78793          	addi	a5,a5,-1206 # 800235a0 <end>
  ...
  acquire(&kmem.lock);
    ...
    80000a76:	8fe90913          	addi	s2,s2,-1794 # 80012370 <kmem>
...
0000000080000af0 <kinit>:
{
  ...
  initlock(&kmem.lock, "kmem");
    ...
    80000b04:	87050513          	addi	a0,a0,-1936 # 80012370 <kmem>
  ...
  freerange(end, (void*)PHYSTOP);
    ...
    80000b14:	a9050513          	addi	a0,a0,-1392 # 800235a0 <end>
...
kalloc(void)
{
  ...
  acquire(&kmem.lock);
    ...
    80000b32:	84248493          	addi	s1,s1,-1982 # 80012370 <kmem>
  ...
  if(r)
    ...
    80000b46:	82e50513          	addi	a0,a0,-2002 # 80012370 <kmem>
  ...
  release(&kmem.lock);
    ...
    80000b6a:	80a50513          	addi	a0,a0,-2038 # 80012370 <kmem>
    ...
    80000d34:	00c587b3          	add	a5,a1,a2
{
    ...
    80000d3c:	0705                	addi	a4,a4,1 # fffffffffffff001 <end+0xffffffff7ffdba61>
...
main()
{
  ...
  if(cpuid() == 0){
    ...
    80000e72:	3da70713          	addi	a4,a4,986 # 8000a248 <started>
  if(cpuid() == 0){
  ...
  scheduler();        
    ...
    binit();         // buffer cache
    80000ef0:	331010ef          	jal	80002a20 <binit>
    iinit();         // inode table
    80000ef4:	122020ef          	jal	80003016 <iinit>
    fileinit();      // file table
    ...
    80000f0e:	32f72f23          	sw	a5,830(a4) # 8000a248 <started>
...
sfence_vma()
{
  ...
  w_satp(MAKE_SATP(kernel_pagetable));
    ...
    80000f22:	3327b783          	ld	a5,818(a5) # 8000a250 <kernel_pagetable>
...
walk(pagetable_t pagetable, uint64 va, int alloc)
{
  ...
  for(int level = 2; level > 0; level--) {
    80000f90:	3a5d                	addiw	s4,s4,-9 # ffffffffffffeff7 <end+0xffffffff7ffdba57>
...
000000008000119e <kvminit>:
{
  ...
  kernel_pagetable = kvmmake();
    ...
    800011ae:	0aa7b323          	sd	a0,166(a5) # 8000a250 <kernel_pagetable>
}
...
proc_mapstacks(pagetable_t kpgtbl)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001780:	04448493          	addi	s1,s1,68 # 800127c0 <proc>
    char *pa = kalloc();
    if(pa == 0)
      panic("kalloc");
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    800017ac:	a18a8a93          	addi	s5,s5,-1512 # 800181c0 <tickslock>
    char *pa = kalloc();
...
procinit(void)
{
  ...
  initlock(&pid_lock, "nextpid");
    ...
    8000181e:	b7650513          	addi	a0,a0,-1162 # 80012390 <pid_lock>
  ...
  initlock(&wait_lock, "wait_lock");
    ...
    80001832:	b7a50513          	addi	a0,a0,-1158 # 800123a8 <wait_lock>
    80001836:	b3eff0ef          	jal	80000b74 <initlock>
  for(p = proc; p < &proc[NPROC]; p++) {
    8000183a:	00011497          	auipc	s1,0x11
    8000183e:	f8648493          	addi	s1,s1,-122 # 800127c0 <proc>
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001872:	952a0a13          	addi	s4,s4,-1710 # 800181c0 <tickslock>
      initlock(&p->lock, "proc");
...
mycpu(void)
{
  ...
  return c;
    ...
    800018d4:	af050513          	addi	a0,a0,-1296 # 800123c0 <cpus>
...
myproc(void)
{
  ...
  struct proc *p = c->proc;
    ...
    800018f8:	a9c70713          	addi	a4,a4,-1380 # 80012390 <pid_lock>
...
forkret(void)
{
  ...
  if (first) {
    ...
    80001924:	8a07a783          	lw	a5,-1888(a5) # 8000a1c0 <first.1>
  ...
  usertrapret();
    ...
    80001938:	672010ef          	jal	80002faa <fsinit>
    first = 0;
    8000193c:	00009797          	auipc	a5,0x9
    80001940:	8807a223          	sw	zero,-1916(a5) # 8000a1c0 <first.1>
    __sync_synchronize();
...
000000008000194a <allocpid>:
{
  ...
  acquire(&pid_lock);
    ...
    8000195a:	a3a90913          	addi	s2,s2,-1478 # 80012390 <pid_lock>
    8000195e:	854a                	mv	a0,s2
    80001960:	a94ff0ef          	jal	80000bf4 <acquire>
  pid = nextpid;
    80001964:	00009797          	auipc	a5,0x9
    80001968:	86078793          	addi	a5,a5,-1952 # 8000a1c4 <nextpid>
...
0000000080001aa2 <allocproc>:
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001ab2:	d1248493          	addi	s1,s1,-750 # 800127c0 <proc>
    80001ab6:	00016917          	auipc	s2,0x16
    80001aba:	70a90913          	addi	s2,s2,1802 # 800181c0 <tickslock>
    acquire(&p->lock);
...
0000000080001b48 <userinit>:
{
  ...
  initproc = p;
    ...
    80001b5c:	70a7b023          	sd	a0,1792(a5) # 8000a258 <initproc>
  uvmfirst(p->pagetable, initcode, sizeof(initcode));
    80001b60:	03400613          	li	a2,52
    80001b64:	00008597          	auipc	a1,0x8
    80001b68:	66c58593          	addi	a1,a1,1644 # 8000a1d0 <initcode>
...
0000000080001c06 <fork>:
{
  ...
  *(np->trapframe) = *(p->trapframe);
  ...
  np->cwd = idup(p->cwd);
    ...
    80001cb2:	4f6010ef          	jal	800031a8 <idup>
  ...
  acquire(&wait_lock);
    ...
    80001cd6:	6d648493          	addi	s1,s1,1750 # 800123a8 <wait_lock>
...
0000000080001d14 <scheduler>:
{
  ...
  c->proc = 0;
    ...
    80001d38:	65c70713          	addi	a4,a4,1628 # 80012390 <pid_lock>
    80001d3c:	975a                	add	a4,a4,s6
    80001d3e:	02073823          	sd	zero,48(a4)
        swtch(&c->context, &p->context);
    80001d42:	00010717          	auipc	a4,0x10
    80001d46:	68670713          	addi	a4,a4,1670 # 800123c8 <cpus+0x8>
    ...
    80001d54:	640a0a13          	addi	s4,s4,1600 # 80012390 <pid_lock>
    80001d58:	9a3e                	add	s4,s4,a5
        found = 1;
    80001d5a:	4b85                	li	s7,1
    for(p = proc; p < &proc[NPROC]; p++) {
    80001d5c:	00016997          	auipc	s3,0x16
    80001d60:	46498993          	addi	s3,s3,1124 # 800181c0 <tickslock>
  ...
  asm volatile("csrw sstatus, %0" : : "r" (x));
    ...
    80001dc0:	a0448493          	addi	s1,s1,-1532 # 800127c0 <proc>
      if(p->state == RUNNABLE) {
...
0000000080001dc8 <sched>:
{
  ...
  if(mycpu()->noff != 1)
    ...
    80001dec:	5a870713          	addi	a4,a4,1448 # 80012390 <pid_lock>
  ...
  intena = mycpu()->intena;
    ...
    80001e12:	58290913          	addi	s2,s2,1410 # 80012390 <pid_lock>
  ...
  swtch(&p->context, &mycpu()->context);
    ...
    80001e2a:	5a258593          	addi	a1,a1,1442 # 800123c8 <cpus+0x8>
...
wakeup(void *chan)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001f12:	8b248493          	addi	s1,s1,-1870 # 800127c0 <proc>
    if(p != myproc()){
      acquire(&p->lock);
  ...
  for(p = proc; p < &proc[NPROC]; p++) {
    ...
    80001f1e:	2a690913          	addi	s2,s2,678 # 800181c0 <tickslock>
...
0000000080001f64 <reparent>:
{
  ...
  for(pp = proc; pp < &proc[NPROC]; pp++){
    ...
    80001f7a:	84a48493          	addi	s1,s1,-1974 # 800127c0 <proc>
      pp->parent = initproc;
    80001f7e:	00008a17          	auipc	s4,0x8
    80001f82:	2daa0a13          	addi	s4,s4,730 # 8000a258 <initproc>
  for(pp = proc; pp < &proc[NPROC]; pp++){
    80001f86:	00016997          	auipc	s3,0x16
    80001f8a:	23a98993          	addi	s3,s3,570 # 800181c0 <tickslock>
...
0000000080001fba <exit>:
{
  ...
  if(p == initproc)
    ...
    80001fd6:	2867b783          	ld	a5,646(a5) # 8000a258 <initproc>
  ...
  iput(p->cwd);
    ...
    8000200e:	352010ef          	jal	80003360 <iput>
  end_op();
  ...
  acquire(&wait_lock);
    ...
    8000201e:	38e48493          	addi	s1,s1,910 # 800123a8 <wait_lock>
...
kill(int pid)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    80002070:	75448493          	addi	s1,s1,1876 # 800127c0 <proc>
    80002074:	00016997          	auipc	s3,0x16
    80002078:	14c98993          	addi	s3,s3,332 # 800181c0 <tickslock>
    acquire(&p->lock);
...
0000000080002110 <wait>:
{
  ...
  acquire(&wait_lock);
    ...
    80002134:	27850513          	addi	a0,a0,632 # 800123a8 <wait_lock>
    ...
    80002146:	07e98993          	addi	s3,s3,126 # 800181c0 <tickslock>
    sleep(p, &wait_lock);  //DOC: wait-sleep
    8000214a:	00010c17          	auipc	s8,0x10
    8000214e:	25ec0c13          	addi	s8,s8,606 # 800123a8 <wait_lock>
    ...
    80002180:	22c50513          	addi	a0,a0,556 # 800123a8 <wait_lock>
    ...
    800021ac:	20050513          	addi	a0,a0,512 # 800123a8 <wait_lock>
    ...
    800021f4:	5d048493          	addi	s1,s1,1488 # 800127c0 <proc>
    800021f8:	b7e1                	j	800021c0 <wait+0xb0>
      release(&wait_lock);
    800021fa:	00010517          	auipc	a0,0x10
    800021fe:	1ae50513          	addi	a0,a0,430 # 800123a8 <wait_lock>
...
procdump(void)
{
  ...
  for(p = proc; p < &proc[NPROC]; p++){
    ...
    800022c4:	65848493          	addi	s1,s1,1624 # 80012918 <proc+0x158>
    800022c8:	00016917          	auipc	s2,0x16
    800022cc:	05090913          	addi	s2,s2,80 # 80018318 <bcache+0x140>
    if(p->state == UNUSED)
      continue;
    ...
    800022ee:	4beb8b93          	addi	s7,s7,1214 # 800077a8 <states.0>
...
trapinit(void)
{
  ...
  initlock(&tickslock, "time");
    ...
    800023c0:	e0450513          	addi	a0,a0,-508 # 800181c0 <tickslock>
...
clockintr()
{
  ...
  asm volatile("csrw 0x14d, %0" : : "r" (x));
    ...
    800024a8:	d1c48493          	addi	s1,s1,-740 # 800181c0 <tickslock>
    800024ac:	8526                	mv	a0,s1
    800024ae:	f46fe0ef          	jal	80000bf4 <acquire>
    ticks++;
    800024b2:	00008517          	auipc	a0,0x8
    800024b6:	dae50513          	addi	a0,a0,-594 # 8000a260 <ticks>
...
argraw(int n)
{
  ...
  switch (n) {
    ...
    800026c6:	11670713          	addi	a4,a4,278 # 800077d8 <states.0+0x30>
...
syscall(void)
{
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    8000282a:	fca78793          	addi	a5,a5,-54 # 800077f0 <syscalls>
...
sys_sleep(void)
{
  ...
  acquire(&tickslock);
    ...
    80002926:	89e50513          	addi	a0,a0,-1890 # 800181c0 <tickslock>
    8000292a:	acafe0ef          	jal	80000bf4 <acquire>
  ticks0 = ticks;
    8000292e:	00008917          	auipc	s2,0x8
    80002932:	93292903          	lw	s2,-1742(s2) # 8000a260 <ticks>
  while(ticks - ticks0 < n){
    ...
    80002944:	88098993          	addi	s3,s3,-1920 # 800181c0 <tickslock>
    80002948:	00008497          	auipc	s1,0x8
    8000294c:	91848493          	addi	s1,s1,-1768 # 8000a260 <ticks>
    if(killed(myproc())){
  ...
  release(&tickslock);
    ...
    80002978:	84c50513          	addi	a0,a0,-1972 # 800181c0 <tickslock>
  ...
  return 0;
    ...
    80002996:	82e50513          	addi	a0,a0,-2002 # 800181c0 <tickslock>
...
sys_uptime(void)
{
  ...
  acquire(&tickslock);
    ...
    800029d6:	7ee50513          	addi	a0,a0,2030 # 800181c0 <tickslock>
    800029da:	a1afe0ef          	jal	80000bf4 <acquire>
  xticks = ticks;
    800029de:	00008497          	auipc	s1,0x8
    800029e2:	8824a483          	lw	s1,-1918(s1) # 8000a260 <ticks>
  release(&tickslock);
    800029e6:	00015517          	auipc	a0,0x15
    800029ea:	7da50513          	addi	a0,a0,2010 # 800181c0 <tickslock>
...
binit(void)
{
  ...
  initlock(&bcache.lock, "bcache");
    80002a30:	00005597          	auipc	a1,0x5
    80002a34:	a2058593          	addi	a1,a1,-1504 # 80007450 <etext+0x450>
    80002a38:	00015517          	auipc	a0,0x15
    80002a3c:	7a050513          	addi	a0,a0,1952 # 800181d8 <bcache>
    80002a40:	934fe0ef          	jal	80000b74 <initlock>

  // Create linked list of buffers
  bcache.head.prev = &bcache.head;
    80002a44:	0001d797          	auipc	a5,0x1d
    80002a48:	79478793          	addi	a5,a5,1940 # 800201d8 <bcache+0x8000>
    80002a4c:	0001e717          	auipc	a4,0x1e
    80002a50:	9f470713          	addi	a4,a4,-1548 # 80020440 <bcache+0x8268>
    80002a54:	2ae7b823          	sd	a4,688(a5)
  bcache.head.next = &bcache.head;
    80002a58:	2ae7bc23          	sd	a4,696(a5)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002a5c:	00015497          	auipc	s1,0x15
    80002a60:	79448493          	addi	s1,s1,1940 # 800181f0 <bcache+0x18>
    b->next = bcache.head.next;
    80002a64:	893e                	mv	s2,a5
    b->prev = &bcache.head;
    80002a66:	89ba                	mv	s3,a4
    initsleeplock(&b->lock, "buffer");
    80002a68:	00005a17          	auipc	s4,0x5
    80002a6c:	9f0a0a13          	addi	s4,s4,-1552 # 80007458 <etext+0x458>
    b->next = bcache.head.next;
    80002a70:	2b893783          	ld	a5,696(s2)
    80002a74:	e8bc                	sd	a5,80(s1)
    b->prev = &bcache.head;
    80002a76:	0534b423          	sd	s3,72(s1)
    initsleeplock(&b->lock, "buffer");
    80002a7a:	85d2                	mv	a1,s4
    80002a7c:	01048513          	addi	a0,s1,16
    80002a80:	248010ef          	jal	80003cc8 <initsleeplock>
    bcache.head.next->prev = b;
    80002a84:	2b893783          	ld	a5,696(s2)
    80002a88:	e7a4                	sd	s1,72(a5)
    bcache.head.next = b;
    80002a8a:	2a993c23          	sd	s1,696(s2)
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
    80002a8e:	45848493          	addi	s1,s1,1112
    80002a92:	fd349fe3          	bne	s1,s3,80002a70 <binit+0x50>
  }
}
...
bread(uint dev, uint blockno)
{
    ...
    80002ab6:	89ae                	mv	s3,a1
  acquire(&bcache.lock);
    80002ab8:	00015517          	auipc	a0,0x15
    80002abc:	72050513          	addi	a0,a0,1824 # 800181d8 <bcache>
    80002ac0:	934fe0ef          	jal	80000bf4 <acquire>
  for(b = bcache.head.next; b != &bcache.head; b = b->next){
    80002ac4:	0001e497          	auipc	s1,0x1e
    80002ac8:	9cc4b483          	ld	s1,-1588(s1) # 80020490 <bcache+0x82b8>
    80002acc:	0001e797          	auipc	a5,0x1e
    80002ad0:	97478793          	addi	a5,a5,-1676 # 80020440 <bcache+0x8268>
    80002ad4:	02f48b63          	beq	s1,a5,80002b0a <bread+0x64>
    80002ad8:	873e                	mv	a4,a5
    80002ada:	a021                	j	80002ae2 <bread+0x3c>
    80002adc:	68a4                	ld	s1,80(s1)
    80002ade:	02e48663          	beq	s1,a4,80002b0a <bread+0x64>
    if(b->dev == dev && b->blockno == blockno){
    80002ae2:	449c                	lw	a5,8(s1)
    80002ae4:	ff279ce3          	bne	a5,s2,80002adc <bread+0x36>
    80002ae8:	44dc                	lw	a5,12(s1)
    80002aea:	ff3799e3          	bne	a5,s3,80002adc <bread+0x36>
      b->refcnt++;
    ...
    80002af8:	6e450513          	addi	a0,a0,1764 # 800181d8 <bcache>
    80002afc:	990fe0ef          	jal	80000c8c <release>
      acquiresleep(&b->lock);
    80002b00:	01048513          	addi	a0,s1,16
    80002b04:	1fa010ef          	jal	80003cfe <acquiresleep>
      return b;
    80002b08:	a889                	j	80002b5a <bread+0xb4>
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    80002b0a:	0001e497          	auipc	s1,0x1e
    80002b0e:	97e4b483          	ld	s1,-1666(s1) # 80020488 <bcache+0x82b0>
    80002b12:	0001e797          	auipc	a5,0x1e
    80002b16:	92e78793          	addi	a5,a5,-1746 # 80020440 <bcache+0x8268>
    80002b1a:	00f48863          	beq	s1,a5,80002b2a <bread+0x84>
    80002b1e:	873e                	mv	a4,a5
    if(b->refcnt == 0) {
    80002b20:	40bc                	lw	a5,64(s1)
    80002b22:	cb91                	beqz	a5,80002b36 <bread+0x90>
  for(b = bcache.head.prev; b != &bcache.head; b = b->prev){
    80002b24:	64a4                	ld	s1,72(s1)
    80002b26:	fee49de3          	bne	s1,a4,80002b20 <bread+0x7a>
  panic("bget: no buffers");
    80002b2a:	00005517          	auipc	a0,0x5
    80002b2e:	93650513          	addi	a0,a0,-1738 # 80007460 <etext+0x460>
    80002b32:	c63fd0ef          	jal	80000794 <panic>
      b->dev = dev;
    80002b36:	0124a423          	sw	s2,8(s1)
      b->blockno = blockno;
    80002b3a:	0134a623          	sw	s3,12(s1)
      b->valid = 0;
    80002b3e:	0004a023          	sw	zero,0(s1)
      b->refcnt = 1;
    80002b42:	4785                	li	a5,1
    80002b44:	c0bc                	sw	a5,64(s1)
      release(&bcache.lock);
    80002b46:	00015517          	auipc	a0,0x15
    80002b4a:	69250513          	addi	a0,a0,1682 # 800181d8 <bcache>
    80002b4e:	93efe0ef          	jal	80000c8c <release>
      acquiresleep(&b->lock);
    80002b52:	01048513          	addi	a0,s1,16
    80002b56:	1a8010ef          	jal	80003cfe <acquiresleep>
  struct buf *b;

  b = bget(dev, blockno);
  if(!b->valid) {
    80002b5a:	409c                	lw	a5,0(s1)
    80002b5c:	cb89                	beqz	a5,80002b6e <bread+0xc8>
    virtio_disk_rw(b, 0);
    b->valid = 1;
  }
  return b;
    ...
    80002b72:	1ef020ef          	jal	80005560 <virtio_disk_rw>
    b->valid = 1;
    80002b76:	4785                	li	a5,1
    80002b78:	c09c                	sw	a5,0(s1)
  return b;
    80002b7a:	b7d5                	j	80002b5e <bread+0xb8>

0000000080002b7c <bwrite>:
...
bwrite(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    ...
    80002b8a:	1f2010ef          	jal	80003d7c <holdingsleep>
    80002b8e:	c911                	beqz	a0,80002ba2 <bwrite+0x26>
    panic("bwrite");
  virtio_disk_rw(b, 1);
    80002b90:	4585                	li	a1,1
    80002b92:	8526                	mv	a0,s1
    80002b94:	1cd020ef          	jal	80005560 <virtio_disk_rw>
}
    ...
    80002ba6:	8d650513          	addi	a0,a0,-1834 # 80007478 <etext+0x478>
    80002baa:	bebfd0ef          	jal	80000794 <panic>

0000000080002bae <brelse>:
...
brelse(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    ...
    80002bc2:	1ba010ef          	jal	80003d7c <holdingsleep>
    80002bc6:	c135                	beqz	a0,80002c2a <brelse+0x7c>
    panic("brelse");

  releasesleep(&b->lock);
    80002bc8:	854a                	mv	a0,s2
    80002bca:	17a010ef          	jal	80003d44 <releasesleep>

  acquire(&bcache.lock);
    80002bce:	00015517          	auipc	a0,0x15
    80002bd2:	60a50513          	addi	a0,a0,1546 # 800181d8 <bcache>
    80002bd6:	81efe0ef          	jal	80000bf4 <acquire>
  b->refcnt--;
    80002bda:	40bc                	lw	a5,64(s1)
    80002bdc:	37fd                	addiw	a5,a5,-1
    80002bde:	0007871b          	sext.w	a4,a5
    80002be2:	c0bc                	sw	a5,64(s1)
  if (b->refcnt == 0) {
    80002be4:	e71d                	bnez	a4,80002c12 <brelse+0x64>
    // no one is waiting for it.
    b->next->prev = b->prev;
    80002be6:	68b8                	ld	a4,80(s1)
    80002be8:	64bc                	ld	a5,72(s1)
    80002bea:	e73c                	sd	a5,72(a4)
    b->prev->next = b->next;
    80002bec:	68b8                	ld	a4,80(s1)
    80002bee:	ebb8                	sd	a4,80(a5)
    b->next = bcache.head.next;
    80002bf0:	0001d797          	auipc	a5,0x1d
    80002bf4:	5e878793          	addi	a5,a5,1512 # 800201d8 <bcache+0x8000>
    80002bf8:	2b87b703          	ld	a4,696(a5)
    80002bfc:	e8b8                	sd	a4,80(s1)
    b->prev = &bcache.head;
    80002bfe:	0001e717          	auipc	a4,0x1e
    80002c02:	84270713          	addi	a4,a4,-1982 # 80020440 <bcache+0x8268>
    80002c06:	e4b8                	sd	a4,72(s1)
    bcache.head.next->prev = b;
    80002c08:	2b87b703          	ld	a4,696(a5)
    80002c0c:	e724                	sd	s1,72(a4)
    bcache.head.next = b;
    80002c0e:	2a97bc23          	sd	s1,696(a5)
  }
  
  release(&bcache.lock);
    80002c12:	00015517          	auipc	a0,0x15
    80002c16:	5c650513          	addi	a0,a0,1478 # 800181d8 <bcache>
    80002c1a:	872fe0ef          	jal	80000c8c <release>
}
    ...
    80002c2e:	85650513          	addi	a0,a0,-1962 # 80007480 <etext+0x480>
    80002c32:	b63fd0ef          	jal	80000794 <panic>

0000000080002c36 <bpin>:
...
bpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    80002c42:	00015517          	auipc	a0,0x15
    80002c46:	59650513          	addi	a0,a0,1430 # 800181d8 <bcache>
    80002c4a:	fabfd0ef          	jal	80000bf4 <acquire>
  b->refcnt++;
    80002c4e:	40bc                	lw	a5,64(s1)
    80002c50:	2785                	addiw	a5,a5,1
    80002c52:	c0bc                	sw	a5,64(s1)
  release(&bcache.lock);
    80002c54:	00015517          	auipc	a0,0x15
    80002c58:	58450513          	addi	a0,a0,1412 # 800181d8 <bcache>
    80002c5c:	830fe0ef          	jal	80000c8c <release>
}
...
bunpin(struct buf *b) {
  ...
  acquire(&bcache.lock);
    80002c76:	00015517          	auipc	a0,0x15
    80002c7a:	56250513          	addi	a0,a0,1378 # 800181d8 <bcache>
    80002c7e:	f77fd0ef          	jal	80000bf4 <acquire>
  b->refcnt--;
    80002c82:	40bc                	lw	a5,64(s1)
    80002c84:	37fd                	addiw	a5,a5,-1
    80002c86:	c0bc                	sw	a5,64(s1)
  release(&bcache.lock);
    80002c88:	00015517          	auipc	a0,0x15
    80002c8c:	55050513          	addi	a0,a0,1360 # 800181d8 <bcache>
    80002c90:	ffdfd0ef          	jal	80000c8c <release>
}
...
bfree(int dev, uint b)
{
  ...
  bp = bread(dev, BBLOCK(b, sb));
    80002cac:	00d5d59b          	srliw	a1,a1,0xd
    80002cb0:	0001e797          	auipc	a5,0x1e
    80002cb4:	c047a783          	lw	a5,-1020(a5) # 800208b4 <sb+0x1c>
    80002cb8:	9dbd                	addw	a1,a1,a5
    80002cba:	dedff0ef          	jal	80002aa6 <bread>
  bi = b % BPB;
  m = 1 << (bi % 8);
    80002cbe:	0074f713          	andi	a4,s1,7
    80002cc2:	4785                	li	a5,1
    80002cc4:	00e797bb          	sllw	a5,a5,a4
  if((bp->data[bi/8] & m) == 0)
    80002cc8:	14ce                	slli	s1,s1,0x33
    80002cca:	90d9                	srli	s1,s1,0x36
    80002ccc:	00950733          	add	a4,a0,s1
    80002cd0:	05874703          	lbu	a4,88(a4)
    80002cd4:	00e7f6b3          	and	a3,a5,a4
    80002cd8:	c29d                	beqz	a3,80002cfe <bfree+0x60>
    80002cda:	892a                	mv	s2,a0
    panic("freeing free block");
  bp->data[bi/8] &= ~m;
    80002cdc:	94aa                	add	s1,s1,a0
    80002cde:	fff7c793          	not	a5,a5
    80002ce2:	8f7d                	and	a4,a4,a5
    80002ce4:	04e48c23          	sb	a4,88(s1)
  log_write(bp);
    80002ce8:	711000ef          	jal	80003bf8 <log_write>
  brelse(bp);
    80002cec:	854a                	mv	a0,s2
    80002cee:	ec1ff0ef          	jal	80002bae <brelse>
}
    ...
    80002d02:	78a50513          	addi	a0,a0,1930 # 80007488 <etext+0x488>
    80002d06:	a8ffd0ef          	jal	80000794 <panic>

0000000080002d0a <balloc>:
{
    80002d0a:	711d                	addi	sp,sp,-96
    80002d0c:	ec86                	sd	ra,88(sp)
    80002d0e:	e8a2                	sd	s0,80(sp)
    80002d10:	e4a6                	sd	s1,72(sp)
    80002d12:	1080                	addi	s0,sp,96
  for(b = 0; b < sb.size; b += BPB){
    80002d14:	0001e797          	auipc	a5,0x1e
    80002d18:	b887a783          	lw	a5,-1144(a5) # 8002089c <sb+0x4>
    80002d1c:	0e078f63          	beqz	a5,80002e1a <balloc+0x110>
    ...
    80002d30:	8baa                	mv	s7,a0
    80002d32:	4a81                	li	s5,0
    bp = bread(dev, BBLOCK(b, sb));
    80002d34:	0001eb17          	auipc	s6,0x1e
    80002d38:	b64b0b13          	addi	s6,s6,-1180 # 80020898 <sb>
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    80002d3c:	4c01                	li	s8,0
      m = 1 << (bi % 8);
    80002d3e:	4985                	li	s3,1
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    80002d40:	6a09                	lui	s4,0x2
  for(b = 0; b < sb.size; b += BPB){
    80002d42:	6c89                	lui	s9,0x2
    80002d44:	a0b5                	j	80002db0 <balloc+0xa6>
        bp->data[bi/8] |= m;  // Mark block in use.
    80002d46:	97ca                	add	a5,a5,s2
    80002d48:	8e55                	or	a2,a2,a3
    80002d4a:	04c78c23          	sb	a2,88(a5)
        log_write(bp);
    80002d4e:	854a                	mv	a0,s2
    80002d50:	6a9000ef          	jal	80003bf8 <log_write>
        brelse(bp);
    80002d54:	854a                	mv	a0,s2
    80002d56:	e59ff0ef          	jal	80002bae <brelse>
  bp = bread(dev, bno);
    80002d5a:	85a6                	mv	a1,s1
    80002d5c:	855e                	mv	a0,s7
    80002d5e:	d49ff0ef          	jal	80002aa6 <bread>
    80002d62:	892a                	mv	s2,a0
  memset(bp->data, 0, BSIZE);
    80002d64:	40000613          	li	a2,1024
    80002d68:	4581                	li	a1,0
    80002d6a:	05850513          	addi	a0,a0,88
    80002d6e:	f5bfd0ef          	jal	80000cc8 <memset>
  log_write(bp);
    80002d72:	854a                	mv	a0,s2
    80002d74:	685000ef          	jal	80003bf8 <log_write>
  brelse(bp);
    80002d78:	854a                	mv	a0,s2
    80002d7a:	e35ff0ef          	jal	80002bae <brelse>
}
    80002d7e:	6906                	ld	s2,64(sp)
    80002d80:	79e2                	ld	s3,56(sp)
    80002d82:	7a42                	ld	s4,48(sp)
    80002d84:	7aa2                	ld	s5,40(sp)
    80002d86:	7b02                	ld	s6,32(sp)
    80002d88:	6be2                	ld	s7,24(sp)
    80002d8a:	6c42                	ld	s8,16(sp)
    80002d8c:	6ca2                	ld	s9,8(sp)
}
    ...
    80002d9c:	e13ff0ef          	jal	80002bae <brelse>
  for(b = 0; b < sb.size; b += BPB){
    80002da0:	015c87bb          	addw	a5,s9,s5
    80002da4:	00078a9b          	sext.w	s5,a5
    80002da8:	004b2703          	lw	a4,4(s6)
    80002dac:	04eaff63          	bgeu	s5,a4,80002e0a <balloc+0x100>
    bp = bread(dev, BBLOCK(b, sb));
    80002db0:	41fad79b          	sraiw	a5,s5,0x1f
    80002db4:	0137d79b          	srliw	a5,a5,0x13
    80002db8:	015787bb          	addw	a5,a5,s5
    80002dbc:	40d7d79b          	sraiw	a5,a5,0xd
    80002dc0:	01cb2583          	lw	a1,28(s6)
    80002dc4:	9dbd                	addw	a1,a1,a5
    80002dc6:	855e                	mv	a0,s7
    80002dc8:	cdfff0ef          	jal	80002aa6 <bread>
    80002dcc:	892a                	mv	s2,a0
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    80002dce:	004b2503          	lw	a0,4(s6)
    80002dd2:	000a849b          	sext.w	s1,s5
    80002dd6:	8762                	mv	a4,s8
    80002dd8:	fca4f1e3          	bgeu	s1,a0,80002d9a <balloc+0x90>
      m = 1 << (bi % 8);
    80002ddc:	00777693          	andi	a3,a4,7
    80002de0:	00d996bb          	sllw	a3,s3,a3
      if((bp->data[bi/8] & m) == 0){  // Is block free?
    80002de4:	41f7579b          	sraiw	a5,a4,0x1f
    80002de8:	01d7d79b          	srliw	a5,a5,0x1d
    80002dec:	9fb9                	addw	a5,a5,a4
    80002dee:	4037d79b          	sraiw	a5,a5,0x3
    80002df2:	00f90633          	add	a2,s2,a5
    80002df6:	05864603          	lbu	a2,88(a2)
    80002dfa:	00c6f5b3          	and	a1,a3,a2
    80002dfe:	d5a1                	beqz	a1,80002d46 <balloc+0x3c>
    for(bi = 0; bi < BPB && b + bi < sb.size; bi++){
    80002e00:	2705                	addiw	a4,a4,1
    80002e02:	2485                	addiw	s1,s1,1
    80002e04:	fd471ae3          	bne	a4,s4,80002dd8 <balloc+0xce>
    80002e08:	bf49                	j	80002d9a <balloc+0x90>
    80002e0a:	6906                	ld	s2,64(sp)
    80002e0c:	79e2                	ld	s3,56(sp)
    80002e0e:	7a42                	ld	s4,48(sp)
    80002e10:	7aa2                	ld	s5,40(sp)
    80002e12:	7b02                	ld	s6,32(sp)
    80002e14:	6be2                	ld	s7,24(sp)
    80002e16:	6c42                	ld	s8,16(sp)
    80002e18:	6ca2                	ld	s9,8(sp)
  printf("balloc: out of blocks\n");
    80002e1a:	00004517          	auipc	a0,0x4
    80002e1e:	68650513          	addi	a0,a0,1670 # 800074a0 <etext+0x4a0>
    80002e22:	ea0fd0ef          	jal	800004c2 <printf>
  return 0;
    80002e26:	4481                	li	s1,0
    80002e28:	b79d                	j	80002d8e <balloc+0x84>

0000000080002e2a <bmap>:
...
bmap(struct inode *ip, uint bn)
{
  ...
  if(bn < NDIRECT){
    80002e3a:	47ad                	li	a5,11
    80002e3c:	02b7e663          	bltu	a5,a1,80002e68 <bmap+0x3e>
    if((addr = ip->addrs[bn]) == 0){
    80002e40:	02059793          	slli	a5,a1,0x20
    80002e44:	01e7d593          	srli	a1,a5,0x1e
    80002e48:	00b504b3          	add	s1,a0,a1
    80002e4c:	0504a903          	lw	s2,80(s1)
    80002e50:	06091a63          	bnez	s2,80002ec4 <bmap+0x9a>
      addr = balloc(ip->dev);
    80002e54:	4108                	lw	a0,0(a0)
    80002e56:	eb5ff0ef          	jal	80002d0a <balloc>
    80002e5a:	0005091b          	sext.w	s2,a0
      if(addr == 0)
    80002e5e:	06090363          	beqz	s2,80002ec4 <bmap+0x9a>
        return 0;
      ip->addrs[bn] = addr;
    80002e62:	0524a823          	sw	s2,80(s1)
    80002e66:	a8b9                	j	80002ec4 <bmap+0x9a>
    }
    return addr;
  }
  bn -= NDIRECT;
    80002e68:	ff45849b          	addiw	s1,a1,-12
    80002e6c:	0004871b          	sext.w	a4,s1

  if(bn < NINDIRECT){
    80002e70:	0ff00793          	li	a5,255
    80002e74:	06e7ee63          	bltu	a5,a4,80002ef0 <bmap+0xc6>
    // Load indirect block, allocating if necessary.
    if((addr = ip->addrs[NDIRECT]) == 0){
    80002e78:	08052903          	lw	s2,128(a0)
    80002e7c:	00091d63          	bnez	s2,80002e96 <bmap+0x6c>
      addr = balloc(ip->dev);
    80002e80:	4108                	lw	a0,0(a0)
    80002e82:	e89ff0ef          	jal	80002d0a <balloc>
    80002e86:	0005091b          	sext.w	s2,a0
      if(addr == 0)
    80002e8a:	02090d63          	beqz	s2,80002ec4 <bmap+0x9a>
    80002e8e:	e052                	sd	s4,0(sp)
        return 0;
      ip->addrs[NDIRECT] = addr;
    80002e90:	0929a023          	sw	s2,128(s3)
    80002e94:	a011                	j	80002e98 <bmap+0x6e>
    80002e96:	e052                	sd	s4,0(sp)
    }
    bp = bread(ip->dev, addr);
    80002e98:	85ca                	mv	a1,s2
    80002e9a:	0009a503          	lw	a0,0(s3)
    80002e9e:	c09ff0ef          	jal	80002aa6 <bread>
    80002ea2:	8a2a                	mv	s4,a0
    a = (uint*)bp->data;
    80002ea4:	05850793          	addi	a5,a0,88
    if((addr = a[bn]) == 0){
    80002ea8:	02049713          	slli	a4,s1,0x20
    80002eac:	01e75593          	srli	a1,a4,0x1e
    80002eb0:	00b784b3          	add	s1,a5,a1
    80002eb4:	0004a903          	lw	s2,0(s1)
    80002eb8:	00090e63          	beqz	s2,80002ed4 <bmap+0xaa>
      if(addr){
        a[bn] = addr;
        log_write(bp);
      }
    ...
    80002ebe:	cf1ff0ef          	jal	80002bae <brelse>
    return addr;
  ...
  panic("bmap: out of range");
    ...
    80002ed8:	e33ff0ef          	jal	80002d0a <balloc>
    80002edc:	0005091b          	sext.w	s2,a0
      if(addr){
    80002ee0:	fc090ee3          	beqz	s2,80002ebc <bmap+0x92>
        a[bn] = addr;
    80002ee4:	0124a023          	sw	s2,0(s1)
        log_write(bp);
    80002ee8:	8552                	mv	a0,s4
    80002eea:	50f000ef          	jal	80003bf8 <log_write>
    80002eee:	b7f9                	j	80002ebc <bmap+0x92>
    80002ef0:	e052                	sd	s4,0(sp)
  panic("bmap: out of range");
    80002ef2:	00004517          	auipc	a0,0x4
    80002ef6:	5c650513          	addi	a0,a0,1478 # 800074b8 <etext+0x4b8>
    80002efa:	89bfd0ef          	jal	80000794 <panic>

0000000080002efe <iget>:
{
  ...
  acquire(&itable.lock);
    80002f12:	0001e517          	auipc	a0,0x1e
    80002f16:	9a650513          	addi	a0,a0,-1626 # 800208b8 <itable>
    80002f1a:	cdbfd0ef          	jal	80000bf4 <acquire>
  empty = 0;
    80002f1e:	4901                	li	s2,0
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80002f20:	0001e497          	auipc	s1,0x1e
    80002f24:	9b048493          	addi	s1,s1,-1616 # 800208d0 <itable+0x18>
    80002f28:	0001f697          	auipc	a3,0x1f
    80002f2c:	43868693          	addi	a3,a3,1080 # 80022360 <log>
    80002f30:	a039                	j	80002f3e <iget+0x40>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    80002f32:	02090963          	beqz	s2,80002f64 <iget+0x66>
  for(ip = &itable.inode[0]; ip < &itable.inode[NINODE]; ip++){
    80002f36:	08848493          	addi	s1,s1,136
    80002f3a:	02d48863          	beq	s1,a3,80002f6a <iget+0x6c>
    if(ip->ref > 0 && ip->dev == dev && ip->inum == inum){
    80002f3e:	449c                	lw	a5,8(s1)
    80002f40:	fef059e3          	blez	a5,80002f32 <iget+0x34>
    80002f44:	4098                	lw	a4,0(s1)
    80002f46:	ff3716e3          	bne	a4,s3,80002f32 <iget+0x34>
    80002f4a:	40d8                	lw	a4,4(s1)
    80002f4c:	ff4713e3          	bne	a4,s4,80002f32 <iget+0x34>
      ip->ref++;
    80002f50:	2785                	addiw	a5,a5,1
    80002f52:	c49c                	sw	a5,8(s1)
      release(&itable.lock);
    80002f54:	0001e517          	auipc	a0,0x1e
    80002f58:	96450513          	addi	a0,a0,-1692 # 800208b8 <itable>
    80002f5c:	d31fd0ef          	jal	80000c8c <release>
      return ip;
    80002f60:	8926                	mv	s2,s1
    80002f62:	a02d                	j	80002f8c <iget+0x8e>
    if(empty == 0 && ip->ref == 0)    // Remember empty slot.
    80002f64:	fbe9                	bnez	a5,80002f36 <iget+0x38>
      empty = ip;
    80002f66:	8926                	mv	s2,s1
    80002f68:	b7f9                	j	80002f36 <iget+0x38>
  if(empty == 0)
    80002f6a:	02090a63          	beqz	s2,80002f9e <iget+0xa0>
  ip->dev = dev;
    80002f6e:	01392023          	sw	s3,0(s2)
  ip->inum = inum;
    80002f72:	01492223          	sw	s4,4(s2)
  ip->ref = 1;
    80002f76:	4785                	li	a5,1
    80002f78:	00f92423          	sw	a5,8(s2)
  ip->valid = 0;
    80002f7c:	04092023          	sw	zero,64(s2)
  release(&itable.lock);
    80002f80:	0001e517          	auipc	a0,0x1e
    80002f84:	93850513          	addi	a0,a0,-1736 # 800208b8 <itable>
    ...
    80002fa2:	53250513          	addi	a0,a0,1330 # 800074d0 <etext+0x4d0>
    80002fa6:	feefd0ef          	jal	80000794 <panic>

0000000080002faa <fsinit>:
fsinit(int dev) {
  ...
  bp = bread(dev, 1);
    ...
    80002fbc:	aebff0ef          	jal	80002aa6 <bread>
    80002fc0:	84aa                	mv	s1,a0
  memmove(sb, bp->data, sizeof(*sb));
    80002fc2:	0001e997          	auipc	s3,0x1e
    80002fc6:	8d698993          	addi	s3,s3,-1834 # 80020898 <sb>
    80002fca:	02000613          	li	a2,32
    80002fce:	05850593          	addi	a1,a0,88
    80002fd2:	854e                	mv	a0,s3
    80002fd4:	d51fd0ef          	jal	80000d24 <memmove>
  brelse(bp);
    80002fd8:	8526                	mv	a0,s1
    80002fda:	bd5ff0ef          	jal	80002bae <brelse>
  if(sb.magic != FSMAGIC)
    80002fde:	0009a703          	lw	a4,0(s3)
    80002fe2:	102037b7          	lui	a5,0x10203
    80002fe6:	04078793          	addi	a5,a5,64 # 10203040 <_entry-0x6fdfcfc0>
    80002fea:	02f71063          	bne	a4,a5,8000300a <fsinit+0x60>
  initlog(dev, &sb);
    80002fee:	0001e597          	auipc	a1,0x1e
    80002ff2:	8aa58593          	addi	a1,a1,-1878 # 80020898 <sb>
    80002ff6:	854a                	mv	a0,s2
    80002ff8:	1f9000ef          	jal	800039f0 <initlog>
}
    ...
    8000300e:	4d650513          	addi	a0,a0,1238 # 800074e0 <etext+0x4e0>
    80003012:	f82fd0ef          	jal	80000794 <panic>

0000000080003016 <iinit>:
{
  ...
  initlock(&itable.lock, "itable");
    ...
    80003028:	4d458593          	addi	a1,a1,1236 # 800074f8 <etext+0x4f8>
    8000302c:	0001e517          	auipc	a0,0x1e
    80003030:	88c50513          	addi	a0,a0,-1908 # 800208b8 <itable>
    80003034:	b41fd0ef          	jal	80000b74 <initlock>
  for(i = 0; i < NINODE; i++) {
    80003038:	0001e497          	auipc	s1,0x1e
    8000303c:	8a848493          	addi	s1,s1,-1880 # 800208e0 <itable+0x28>
    80003040:	0001f997          	auipc	s3,0x1f
    80003044:	33098993          	addi	s3,s3,816 # 80022370 <log+0x10>
    initsleeplock(&itable.inode[i].lock, "inode");
    80003048:	00004917          	auipc	s2,0x4
    8000304c:	4b890913          	addi	s2,s2,1208 # 80007500 <etext+0x500>
    80003050:	85ca                	mv	a1,s2
    80003052:	8526                	mv	a0,s1
    80003054:	475000ef          	jal	80003cc8 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
    80003058:	08848493          	addi	s1,s1,136
    8000305c:	ff349ae3          	bne	s1,s3,80003050 <iinit+0x3a>
}
...
000000008000306e <ialloc>:
{
  ...
  for(inum = 1; inum < sb.ninodes; inum++){
    80003076:	0001e717          	auipc	a4,0x1e
    8000307a:	82e72703          	lw	a4,-2002(a4) # 800208a4 <sb+0xc>
    8000307e:	4785                	li	a5,1
    80003080:	06e7f063          	bgeu	a5,a4,800030e0 <ialloc+0x72>
    80003084:	f426                	sd	s1,40(sp)
    80003086:	f04a                	sd	s2,32(sp)
    80003088:	ec4e                	sd	s3,24(sp)
    8000308a:	e852                	sd	s4,16(sp)
    8000308c:	e456                	sd	s5,8(sp)
    8000308e:	e05a                	sd	s6,0(sp)
    80003090:	8aaa                	mv	s5,a0
    80003092:	8b2e                	mv	s6,a1
    80003094:	4905                	li	s2,1
    bp = bread(dev, IBLOCK(inum, sb));
    80003096:	0001ea17          	auipc	s4,0x1e
    8000309a:	802a0a13          	addi	s4,s4,-2046 # 80020898 <sb>
    8000309e:	00495593          	srli	a1,s2,0x4
    800030a2:	018a2783          	lw	a5,24(s4)
    800030a6:	9dbd                	addw	a1,a1,a5
    800030a8:	8556                	mv	a0,s5
    800030aa:	9fdff0ef          	jal	80002aa6 <bread>
    800030ae:	84aa                	mv	s1,a0
    dip = (struct dinode*)bp->data + inum%IPB;
    800030b0:	05850993          	addi	s3,a0,88
    800030b4:	00f97793          	andi	a5,s2,15
    800030b8:	079a                	slli	a5,a5,0x6
    800030ba:	99be                	add	s3,s3,a5
    if(dip->type == 0){  // a free inode
    800030bc:	00099783          	lh	a5,0(s3)
    800030c0:	cb9d                	beqz	a5,800030f6 <ialloc+0x88>
    brelse(bp);
    800030c2:	aedff0ef          	jal	80002bae <brelse>
  for(inum = 1; inum < sb.ninodes; inum++){
    800030c6:	0905                	addi	s2,s2,1
    800030c8:	00ca2703          	lw	a4,12(s4)
    800030cc:	0009079b          	sext.w	a5,s2
    800030d0:	fce7e7e3          	bltu	a5,a4,8000309e <ialloc+0x30>
  ...
  printf("ialloc: no inodes\n");
    ...
    800030e4:	42850513          	addi	a0,a0,1064 # 80007508 <etext+0x508>
    800030e8:	bdafd0ef          	jal	800004c2 <printf>
  return 0;
    ...
    800030f6:	04000613          	li	a2,64
    800030fa:	4581                	li	a1,0
    800030fc:	854e                	mv	a0,s3
    800030fe:	bcbfd0ef          	jal	80000cc8 <memset>
      dip->type = type;
    80003102:	01699023          	sh	s6,0(s3)
      log_write(bp);   // mark it allocated on the disk
    80003106:	8526                	mv	a0,s1
    80003108:	2f1000ef          	jal	80003bf8 <log_write>
      brelse(bp);
    8000310c:	8526                	mv	a0,s1
    8000310e:	aa1ff0ef          	jal	80002bae <brelse>
      return iget(dev, inum);
    80003112:	0009059b          	sext.w	a1,s2
    80003116:	8556                	mv	a0,s5
    80003118:	de7ff0ef          	jal	80002efe <iget>
    ...
    80003128:	b7d9                	j	800030ee <ialloc+0x80>

000000008000312a <iupdate>:
{
  ...
  bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    80003138:	415c                	lw	a5,4(a0)
    8000313a:	0047d79b          	srliw	a5,a5,0x4
    8000313e:	0001d597          	auipc	a1,0x1d
    80003142:	7725a583          	lw	a1,1906(a1) # 800208b0 <sb+0x18>
    80003146:	9dbd                	addw	a1,a1,a5
    80003148:	4108                	lw	a0,0(a0)
    8000314a:	95dff0ef          	jal	80002aa6 <bread>
    8000314e:	892a                	mv	s2,a0
  dip = (struct dinode*)bp->data + ip->inum%IPB;
    80003150:	05850793          	addi	a5,a0,88
    80003154:	40d8                	lw	a4,4(s1)
    80003156:	8b3d                	andi	a4,a4,15
    80003158:	071a                	slli	a4,a4,0x6
    8000315a:	97ba                	add	a5,a5,a4
  dip->type = ip->type;
    8000315c:	04449703          	lh	a4,68(s1)
    80003160:	00e79023          	sh	a4,0(a5)
  dip->major = ip->major;
    80003164:	04649703          	lh	a4,70(s1)
    80003168:	00e79123          	sh	a4,2(a5)
  dip->minor = ip->minor;
    8000316c:	04849703          	lh	a4,72(s1)
    80003170:	00e79223          	sh	a4,4(a5)
  dip->nlink = ip->nlink;
    80003174:	04a49703          	lh	a4,74(s1)
    80003178:	00e79323          	sh	a4,6(a5)
  dip->size = ip->size;
    8000317c:	44f8                	lw	a4,76(s1)
    8000317e:	c798                	sw	a4,8(a5)
  memmove(dip->addrs, ip->addrs, sizeof(ip->addrs));
    80003180:	03400613          	li	a2,52
    80003184:	05048593          	addi	a1,s1,80
    80003188:	00c78513          	addi	a0,a5,12
    8000318c:	b99fd0ef          	jal	80000d24 <memmove>
  log_write(bp);
    80003190:	854a                	mv	a0,s2
    80003192:	267000ef          	jal	80003bf8 <log_write>
  brelse(bp);
    80003196:	854a                	mv	a0,s2
    80003198:	a17ff0ef          	jal	80002bae <brelse>
}
...
00000000800031a8 <idup>:
{
  ...
  acquire(&itable.lock);
    800031b4:	0001d517          	auipc	a0,0x1d
    800031b8:	70450513          	addi	a0,a0,1796 # 800208b8 <itable>
    800031bc:	a39fd0ef          	jal	80000bf4 <acquire>
  ip->ref++;
    800031c0:	449c                	lw	a5,8(s1)
    800031c2:	2785                	addiw	a5,a5,1
    800031c4:	c49c                	sw	a5,8(s1)
  release(&itable.lock);
    800031c6:	0001d517          	auipc	a0,0x1d
    800031ca:	6f250513          	addi	a0,a0,1778 # 800208b8 <itable>
    800031ce:	abffd0ef          	jal	80000c8c <release>
}
...
00000000800031de <ilock>:
{
  ...
  if(ip == 0 || ip->ref < 1)
    800031e8:	cd19                	beqz	a0,80003206 <ilock+0x28>
    800031ea:	84aa                	mv	s1,a0
    800031ec:	451c                	lw	a5,8(a0)
    800031ee:	00f05c63          	blez	a5,80003206 <ilock+0x28>
  acquiresleep(&ip->lock);
    800031f2:	0541                	addi	a0,a0,16
    800031f4:	30b000ef          	jal	80003cfe <acquiresleep>
  if(ip->valid == 0){
    800031f8:	40bc                	lw	a5,64(s1)
    800031fa:	cf89                	beqz	a5,80003214 <ilock+0x36>
}
    ...
    8000320c:	31850513          	addi	a0,a0,792 # 80007520 <etext+0x520>
    80003210:	d84fd0ef          	jal	80000794 <panic>
    80003214:	e04a                	sd	s2,0(sp)
    bp = bread(ip->dev, IBLOCK(ip->inum, sb));
    80003216:	40dc                	lw	a5,4(s1)
    80003218:	0047d79b          	srliw	a5,a5,0x4
    8000321c:	0001d597          	auipc	a1,0x1d
    80003220:	6945a583          	lw	a1,1684(a1) # 800208b0 <sb+0x18>
    80003224:	9dbd                	addw	a1,a1,a5
    80003226:	4088                	lw	a0,0(s1)
    80003228:	87fff0ef          	jal	80002aa6 <bread>
    8000322c:	892a                	mv	s2,a0
    dip = (struct dinode*)bp->data + ip->inum%IPB;
    8000322e:	05850593          	addi	a1,a0,88
    80003232:	40dc                	lw	a5,4(s1)
    80003234:	8bbd                	andi	a5,a5,15
    80003236:	079a                	slli	a5,a5,0x6
    80003238:	95be                	add	a1,a1,a5
    ip->type = dip->type;
    8000323a:	00059783          	lh	a5,0(a1)
    8000323e:	04f49223          	sh	a5,68(s1)
    ip->major = dip->major;
    80003242:	00259783          	lh	a5,2(a1)
    80003246:	04f49323          	sh	a5,70(s1)
    ip->minor = dip->minor;
    8000324a:	00459783          	lh	a5,4(a1)
    8000324e:	04f49423          	sh	a5,72(s1)
    ip->nlink = dip->nlink;
    80003252:	00659783          	lh	a5,6(a1)
    80003256:	04f49523          	sh	a5,74(s1)
    ip->size = dip->size;
    8000325a:	459c                	lw	a5,8(a1)
    8000325c:	c4fc                	sw	a5,76(s1)
    memmove(ip->addrs, dip->addrs, sizeof(ip->addrs));
    8000325e:	03400613          	li	a2,52
    80003262:	05b1                	addi	a1,a1,12
    80003264:	05048513          	addi	a0,s1,80
    80003268:	abdfd0ef          	jal	80000d24 <memmove>
    brelse(bp);
    8000326c:	854a                	mv	a0,s2
    8000326e:	941ff0ef          	jal	80002bae <brelse>
    ip->valid = 1;
    80003272:	4785                	li	a5,1
    80003274:	c0bc                	sw	a5,64(s1)
    if(ip->type == 0)
    80003276:	04449783          	lh	a5,68(s1)
    8000327a:	c399                	beqz	a5,80003280 <ilock+0xa2>
    8000327c:	6902                	ld	s2,0(sp)
    8000327e:	bfbd                	j	800031fc <ilock+0x1e>
      panic("ilock: no type");
    80003280:	00004517          	auipc	a0,0x4
    80003284:	2a850513          	addi	a0,a0,680 # 80007528 <etext+0x528>
    80003288:	d0cfd0ef          	jal	80000794 <panic>

000000008000328c <iunlock>:
{
  ...
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    80003298:	c505                	beqz	a0,800032c0 <iunlock+0x34>
    8000329a:	84aa                	mv	s1,a0
    8000329c:	01050913          	addi	s2,a0,16
    800032a0:	854a                	mv	a0,s2
    800032a2:	2db000ef          	jal	80003d7c <holdingsleep>
    800032a6:	cd09                	beqz	a0,800032c0 <iunlock+0x34>
    800032a8:	449c                	lw	a5,8(s1)
    800032aa:	00f05b63          	blez	a5,800032c0 <iunlock+0x34>
  releasesleep(&ip->lock);
    800032ae:	854a                	mv	a0,s2
    800032b0:	295000ef          	jal	80003d44 <releasesleep>
}
    ...
    800032c4:	27850513          	addi	a0,a0,632 # 80007538 <etext+0x538>
    800032c8:	cccfd0ef          	jal	80000794 <panic>

00000000800032cc <itrunc>:
...
itrunc(struct inode *ip)
{
  ...
  for(i = 0; i < NDIRECT; i++){
    800032dc:	05050493          	addi	s1,a0,80
    800032e0:	08050913          	addi	s2,a0,128
    800032e4:	a021                	j	800032ec <itrunc+0x20>
    800032e6:	0491                	addi	s1,s1,4
    800032e8:	01248b63          	beq	s1,s2,800032fe <itrunc+0x32>
    if(ip->addrs[i]){
    800032ec:	408c                	lw	a1,0(s1)
    800032ee:	dde5                	beqz	a1,800032e6 <itrunc+0x1a>
      bfree(ip->dev, ip->addrs[i]);
    800032f0:	0009a503          	lw	a0,0(s3)
    800032f4:	9abff0ef          	jal	80002c9e <bfree>
      ip->addrs[i] = 0;
    800032f8:	0004a023          	sw	zero,0(s1)
    800032fc:	b7ed                	j	800032e6 <itrunc+0x1a>
    }
  }

  if(ip->addrs[NDIRECT]){
    800032fe:	0809a583          	lw	a1,128(s3)
    80003302:	ed89                	bnez	a1,8000331c <itrunc+0x50>
    brelse(bp);
  ...
  ip->size = 0;
    80003304:	0409a623          	sw	zero,76(s3)
  iupdate(ip);
    80003308:	854e                	mv	a0,s3
    8000330a:	e21ff0ef          	jal	8000312a <iupdate>
}
    ...
    80003322:	f84ff0ef          	jal	80002aa6 <bread>
    80003326:	8a2a                	mv	s4,a0
    for(j = 0; j < NINDIRECT; j++){
    80003328:	05850493          	addi	s1,a0,88
    8000332c:	45850913          	addi	s2,a0,1112
    80003330:	a021                	j	80003338 <itrunc+0x6c>
    80003332:	0491                	addi	s1,s1,4
    80003334:	01248963          	beq	s1,s2,80003346 <itrunc+0x7a>
      if(a[j])
    80003338:	408c                	lw	a1,0(s1)
    8000333a:	dde5                	beqz	a1,80003332 <itrunc+0x66>
        bfree(ip->dev, a[j]);
    8000333c:	0009a503          	lw	a0,0(s3)
    80003340:	95fff0ef          	jal	80002c9e <bfree>
    80003344:	b7fd                	j	80003332 <itrunc+0x66>
    brelse(bp);
    80003346:	8552                	mv	a0,s4
    80003348:	867ff0ef          	jal	80002bae <brelse>
    bfree(ip->dev, ip->addrs[NDIRECT]);
    8000334c:	0809a583          	lw	a1,128(s3)
    80003350:	0009a503          	lw	a0,0(s3)
    80003354:	94bff0ef          	jal	80002c9e <bfree>
    ip->addrs[NDIRECT] = 0;
    80003358:	0809a023          	sw	zero,128(s3)
    8000335c:	6a02                	ld	s4,0(sp)
    8000335e:	b75d                	j	80003304 <itrunc+0x38>

0000000080003360 <iput>:
{
  ...
  acquire(&itable.lock);
    8000336c:	0001d517          	auipc	a0,0x1d
    80003370:	54c50513          	addi	a0,a0,1356 # 800208b8 <itable>
    80003374:	881fd0ef          	jal	80000bf4 <acquire>
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    80003378:	4498                	lw	a4,8(s1)
    8000337a:	4785                	li	a5,1
    8000337c:	02f70063          	beq	a4,a5,8000339c <iput+0x3c>
  ip->ref--;
  ...
  release(&itable.lock);
    ...
    8000338a:	53250513          	addi	a0,a0,1330 # 800208b8 <itable>
  ...
  if(ip->ref == 1 && ip->valid && ip->nlink == 0){
    ...
    8000339e:	d3ed                	beqz	a5,80003380 <iput+0x20>
    800033a0:	04a49783          	lh	a5,74(s1)
    800033a4:	fff1                	bnez	a5,80003380 <iput+0x20>
    800033a6:	e04a                	sd	s2,0(sp)
    acquiresleep(&ip->lock);
    800033a8:	01048913          	addi	s2,s1,16
    800033ac:	854a                	mv	a0,s2
    800033ae:	151000ef          	jal	80003cfe <acquiresleep>
    release(&itable.lock);
    800033b2:	0001d517          	auipc	a0,0x1d
    800033b6:	50650513          	addi	a0,a0,1286 # 800208b8 <itable>
    800033ba:	8d3fd0ef          	jal	80000c8c <release>
    itrunc(ip);
    800033be:	8526                	mv	a0,s1
    800033c0:	f0dff0ef          	jal	800032cc <itrunc>
    ip->type = 0;
    800033c4:	04049223          	sh	zero,68(s1)
    iupdate(ip);
    800033c8:	8526                	mv	a0,s1
    800033ca:	d61ff0ef          	jal	8000312a <iupdate>
    ip->valid = 0;
    800033ce:	0404a023          	sw	zero,64(s1)
    releasesleep(&ip->lock);
    800033d2:	854a                	mv	a0,s2
    800033d4:	171000ef          	jal	80003d44 <releasesleep>
    acquire(&itable.lock);
    800033d8:	0001d517          	auipc	a0,0x1d
    800033dc:	4e050513          	addi	a0,a0,1248 # 800208b8 <itable>
    800033e0:	815fd0ef          	jal	80000bf4 <acquire>
    800033e4:	6902                	ld	s2,0(sp)
    800033e6:	bf69                	j	80003380 <iput+0x20>

00000000800033e8 <iunlockput>:
{
  ...
  iunlock(ip);
    800033f4:	e99ff0ef          	jal	8000328c <iunlock>
  iput(ip);
    800033f8:	8526                	mv	a0,s1
    800033fa:	f67ff0ef          	jal	80003360 <iput>
}
...
stati(struct inode *ip, struct stat *st)
{
    ...
    8000340a:	e422                	sd	s0,8(sp)
    8000340c:	0800                	addi	s0,sp,16
  st->dev = ip->dev;
    8000340e:	411c                	lw	a5,0(a0)
    80003410:	c19c                	sw	a5,0(a1)
  st->ino = ip->inum;
    80003412:	415c                	lw	a5,4(a0)
    80003414:	c1dc                	sw	a5,4(a1)
  st->type = ip->type;
    80003416:	04451783          	lh	a5,68(a0)
    8000341a:	00f59423          	sh	a5,8(a1)
  st->nlink = ip->nlink;
    8000341e:	04a51783          	lh	a5,74(a0)
    80003422:	00f59523          	sh	a5,10(a1)
  st->size = ip->size;
    80003426:	04c56783          	lwu	a5,76(a0)
    8000342a:	e99c                	sd	a5,16(a1)
}
    8000342c:	6422                	ld	s0,8(sp)
    8000342e:	0141                	addi	sp,sp,16
    80003430:	8082                	ret

0000000080003432 <readi>:
readi(struct inode *ip, int user_dst, uint64 dst, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    80003432:	457c                	lw	a5,76(a0)
    80003434:	0ed7eb63          	bltu	a5,a3,8000352a <readi+0xf8>
{
    80003438:	7159                	addi	sp,sp,-112
    8000343a:	f486                	sd	ra,104(sp)
    8000343c:	f0a2                	sd	s0,96(sp)
    8000343e:	eca6                	sd	s1,88(sp)
    80003440:	e0d2                	sd	s4,64(sp)
    80003442:	fc56                	sd	s5,56(sp)
    80003444:	f85a                	sd	s6,48(sp)
    80003446:	f45e                	sd	s7,40(sp)
    80003448:	1880                	addi	s0,sp,112
    8000344a:	8b2a                	mv	s6,a0
    8000344c:	8bae                	mv	s7,a1
    8000344e:	8a32                	mv	s4,a2
    80003450:	84b6                	mv	s1,a3
    80003452:	8aba                	mv	s5,a4
  if(off > ip->size || off + n < off)
    80003454:	9f35                	addw	a4,a4,a3
    return 0;
    80003456:	4501                	li	a0,0
  if(off > ip->size || off + n < off)
    80003458:	0cd76063          	bltu	a4,a3,80003518 <readi+0xe6>
    8000345c:	e4ce                	sd	s3,72(sp)
  if(off + n > ip->size)
    8000345e:	00e7f463          	bgeu	a5,a4,80003466 <readi+0x34>
    n = ip->size - off;
    80003462:	40d78abb          	subw	s5,a5,a3

  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80003466:	080a8f63          	beqz	s5,80003504 <readi+0xd2>
    8000346a:	e8ca                	sd	s2,80(sp)
    8000346c:	f062                	sd	s8,32(sp)
    8000346e:	ec66                	sd	s9,24(sp)
    80003470:	e86a                	sd	s10,16(sp)
    80003472:	e46e                	sd	s11,8(sp)
    ...
    80003476:	40000c93          	li	s9,1024
    if(either_copyout(user_dst, dst, bp->data + (off % BSIZE), m) == -1) {
    8000347a:	5c7d                	li	s8,-1
    8000347c:	a80d                	j	800034ae <readi+0x7c>
    8000347e:	020d1d93          	slli	s11,s10,0x20
    80003482:	020ddd93          	srli	s11,s11,0x20
    80003486:	05890613          	addi	a2,s2,88
    8000348a:	86ee                	mv	a3,s11
    8000348c:	963a                	add	a2,a2,a4
    8000348e:	85d2                	mv	a1,s4
    80003490:	855e                	mv	a0,s7
    80003492:	d79fe0ef          	jal	8000220a <either_copyout>
    80003496:	05850763          	beq	a0,s8,800034e4 <readi+0xb2>
      brelse(bp);
      tot = -1;
      break;
    }
    ...
    8000349c:	f12ff0ef          	jal	80002bae <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    800034a0:	013d09bb          	addw	s3,s10,s3
    800034a4:	009d04bb          	addw	s1,s10,s1
    800034a8:	9a6e                	add	s4,s4,s11
    800034aa:	0559f763          	bgeu	s3,s5,800034f8 <readi+0xc6>
    uint addr = bmap(ip, off/BSIZE);
    800034ae:	00a4d59b          	srliw	a1,s1,0xa
    800034b2:	855a                	mv	a0,s6
    800034b4:	977ff0ef          	jal	80002e2a <bmap>
    800034b8:	0005059b          	sext.w	a1,a0
    if(addr == 0)
    800034bc:	c5b1                	beqz	a1,80003508 <readi+0xd6>
    bp = bread(ip->dev, addr);
    800034be:	000b2503          	lw	a0,0(s6)
    800034c2:	de4ff0ef          	jal	80002aa6 <bread>
    800034c6:	892a                	mv	s2,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    800034c8:	3ff4f713          	andi	a4,s1,1023
    800034cc:	40ec87bb          	subw	a5,s9,a4
    800034d0:	413a86bb          	subw	a3,s5,s3
    800034d4:	8d3e                	mv	s10,a5
    800034d6:	2781                	sext.w	a5,a5
    800034d8:	0006861b          	sext.w	a2,a3
    800034dc:	faf671e3          	bgeu	a2,a5,8000347e <readi+0x4c>
    800034e0:	8d36                	mv	s10,a3
    800034e2:	bf71                	j	8000347e <readi+0x4c>
      brelse(bp);
    800034e4:	854a                	mv	a0,s2
    800034e6:	ec8ff0ef          	jal	80002bae <brelse>
      tot = -1;
    800034ea:	59fd                	li	s3,-1
      break;
    ...
    800034f6:	a831                	j	80003512 <readi+0xe0>
    ...
    80003502:	a801                	j	80003512 <readi+0xe0>
  for(tot=0; tot<n; tot+=m, off+=m, dst+=m){
    80003504:	89d6                	mv	s3,s5
    80003506:	a031                	j	80003512 <readi+0xe0>
    80003508:	6946                	ld	s2,80(sp)
  ...
  return tot;
    80003512:	0009851b          	sext.w	a0,s3
    80003516:	69a6                	ld	s3,72(sp)
}
    80003518:	70a6                	ld	ra,104(sp)
    8000351a:	7406                	ld	s0,96(sp)
    8000351c:	64e6                	ld	s1,88(sp)
    8000351e:	6a06                	ld	s4,64(sp)
    80003520:	7ae2                	ld	s5,56(sp)
    80003522:	7b42                	ld	s6,48(sp)
    80003524:	7ba2                	ld	s7,40(sp)
...
writei(struct inode *ip, int user_src, uint64 src, uint off, uint n)
{
  ...
  if(off > ip->size || off + n < off)
    8000352e:	457c                	lw	a5,76(a0)
    80003530:	10d7e063          	bltu	a5,a3,80003630 <writei+0x102>
{
    80003534:	7159                	addi	sp,sp,-112
    80003536:	f486                	sd	ra,104(sp)
    80003538:	f0a2                	sd	s0,96(sp)
    8000353a:	e8ca                	sd	s2,80(sp)
    8000353c:	e0d2                	sd	s4,64(sp)
    8000353e:	fc56                	sd	s5,56(sp)
    80003540:	f85a                	sd	s6,48(sp)
    80003542:	f45e                	sd	s7,40(sp)
    80003544:	1880                	addi	s0,sp,112
    80003546:	8aaa                	mv	s5,a0
    80003548:	8bae                	mv	s7,a1
    8000354a:	8a32                	mv	s4,a2
    8000354c:	8936                	mv	s2,a3
    8000354e:	8b3a                	mv	s6,a4
  if(off > ip->size || off + n < off)
    80003550:	00e687bb          	addw	a5,a3,a4
    80003554:	0ed7e063          	bltu	a5,a3,80003634 <writei+0x106>
    return -1;
  if(off + n > MAXFILE*BSIZE)
    80003558:	00043737          	lui	a4,0x43
    8000355c:	0cf76e63          	bltu	a4,a5,80003638 <writei+0x10a>
    80003560:	e4ce                	sd	s3,72(sp)
    return -1;

  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80003562:	0a0b0f63          	beqz	s6,80003620 <writei+0xf2>
    80003566:	eca6                	sd	s1,88(sp)
    80003568:	f062                	sd	s8,32(sp)
    8000356a:	ec66                	sd	s9,24(sp)
    8000356c:	e86a                	sd	s10,16(sp)
    8000356e:	e46e                	sd	s11,8(sp)
    80003570:	4981                	li	s3,0
    uint addr = bmap(ip, off/BSIZE);
    if(addr == 0)
      break;
    bp = bread(ip->dev, addr);
    m = min(n - tot, BSIZE - off%BSIZE);
    80003572:	40000c93          	li	s9,1024
    if(either_copyin(bp->data + (off % BSIZE), user_src, src, m) == -1) {
    80003576:	5c7d                	li	s8,-1
    80003578:	a825                	j	800035b0 <writei+0x82>
    8000357a:	020d1d93          	slli	s11,s10,0x20
    8000357e:	020ddd93          	srli	s11,s11,0x20
    80003582:	05848513          	addi	a0,s1,88
    80003586:	86ee                	mv	a3,s11
    80003588:	8652                	mv	a2,s4
    8000358a:	85de                	mv	a1,s7
    8000358c:	953a                	add	a0,a0,a4
    8000358e:	cc7fe0ef          	jal	80002254 <either_copyin>
    80003592:	05850a63          	beq	a0,s8,800035e6 <writei+0xb8>
      brelse(bp);
      break;
    }
    log_write(bp);
    80003596:	8526                	mv	a0,s1
    80003598:	660000ef          	jal	80003bf8 <log_write>
    brelse(bp);
    8000359c:	8526                	mv	a0,s1
    8000359e:	e10ff0ef          	jal	80002bae <brelse>
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    800035a2:	013d09bb          	addw	s3,s10,s3
    800035a6:	012d093b          	addw	s2,s10,s2
    800035aa:	9a6e                	add	s4,s4,s11
    800035ac:	0569f063          	bgeu	s3,s6,800035ec <writei+0xbe>
    uint addr = bmap(ip, off/BSIZE);
    800035b0:	00a9559b          	srliw	a1,s2,0xa
    800035b4:	8556                	mv	a0,s5
    800035b6:	875ff0ef          	jal	80002e2a <bmap>
    800035ba:	0005059b          	sext.w	a1,a0
    if(addr == 0)
    800035be:	c59d                	beqz	a1,800035ec <writei+0xbe>
    bp = bread(ip->dev, addr);
    800035c0:	000aa503          	lw	a0,0(s5)
    800035c4:	ce2ff0ef          	jal	80002aa6 <bread>
    800035c8:	84aa                	mv	s1,a0
    m = min(n - tot, BSIZE - off%BSIZE);
    800035ca:	3ff97713          	andi	a4,s2,1023
    800035ce:	40ec87bb          	subw	a5,s9,a4
    800035d2:	413b06bb          	subw	a3,s6,s3
    800035d6:	8d3e                	mv	s10,a5
    800035d8:	2781                	sext.w	a5,a5
    800035da:	0006861b          	sext.w	a2,a3
    800035de:	f8f67ee3          	bgeu	a2,a5,8000357a <writei+0x4c>
    800035e2:	8d36                	mv	s10,a3
    800035e4:	bf59                	j	8000357a <writei+0x4c>
      brelse(bp);
    800035e6:	8526                	mv	a0,s1
    800035e8:	dc6ff0ef          	jal	80002bae <brelse>
  }

  if(off > ip->size)
    800035ec:	04caa783          	lw	a5,76(s5)
    800035f0:	0327fa63          	bgeu	a5,s2,80003624 <writei+0xf6>
    ip->size = off;
    800035f4:	052aa623          	sw	s2,76(s5)
    800035f8:	64e6                	ld	s1,88(sp)
  ...
  iupdate(ip);
    ...
    80003604:	b27ff0ef          	jal	8000312a <iupdate>

  return tot;
    80003608:	0009851b          	sext.w	a0,s3
    8000360c:	69a6                	ld	s3,72(sp)
}
    8000360e:	70a6                	ld	ra,104(sp)
    80003610:	7406                	ld	s0,96(sp)
    80003612:	6946                	ld	s2,80(sp)
    80003614:	6a06                	ld	s4,64(sp)
    80003616:	7ae2                	ld	s5,56(sp)
    80003618:	7b42                	ld	s6,48(sp)
    8000361a:	7ba2                	ld	s7,40(sp)
    8000361c:	6165                	addi	sp,sp,112
    8000361e:	8082                	ret
  for(tot=0; tot<n; tot+=m, off+=m, src+=m){
    80003620:	89da                	mv	s3,s6
    80003622:	b7c5                	j	80003602 <writei+0xd4>
    ...
    8000362e:	bfd1                	j	80003602 <writei+0xd4>
    return -1;
    ...
    80003636:	bfe1                	j	8000360e <writei+0xe0>
    return -1;
    80003638:	557d                	li	a0,-1
    8000363a:	bfd1                	j	8000360e <writei+0xe0>
...
dirlookup(struct inode *dp, char *name, uint *poff)
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003680:	ec450513          	addi	a0,a0,-316 # 80007540 <etext+0x540>
    80003684:	910fd0ef          	jal	80000794 <panic>
      panic("dirlookup read");
    80003688:	00004517          	auipc	a0,0x4
    8000368c:	ed050513          	addi	a0,a0,-304 # 80007558 <etext+0x558>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    800036aa:	d89ff0ef          	jal	80003432 <readi>
    ...
    800036d6:	829ff0ef          	jal	80002efe <iget>
...
namex(char *path, int nameiparent, char *name)
{
  ...
  if(*path == '/')
    ...
    80003722:	a87ff0ef          	jal	800031a8 <idup>
  ...
  return ip;
    ...
    80003764:	b29ff0ef          	jal	8000328c <iunlock>
      return ip;
    80003768:	bff9                	j	80003746 <namex+0x58>
      iunlockput(ip);
    8000376a:	8552                	mv	a0,s4
    8000376c:	c7dff0ef          	jal	800033e8 <iunlockput>
      return 0;
  ...
  while(*path == '/')
    ...
    800037a0:	a3fff0ef          	jal	800031de <ilock>
    if(ip->type != T_DIR){
    ...
    800037c6:	c23ff0ef          	jal	800033e8 <iunlockput>
    ip = next;
  ...
  if(nameiparent){
    ...
    80003816:	b4bff0ef          	jal	80003360 <iput>
    return 0;
...
000000008000381e <dirlink>:
{
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    ...
    80003850:	be3ff0ef          	jal	80003432 <readi>
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80003886:	ca9ff0ef          	jal	8000352e <writei>
    ...
    800038a2:	8082                	ret
    iput(ip);
    800038a4:	abdff0ef          	jal	80003360 <iput>
    return -1;
    800038a8:	557d                	li	a0,-1
    800038aa:	b7f5                	j	80003896 <dirlink+0x78>
      panic("dirlink read");
    800038ac:	00004517          	auipc	a0,0x4
    800038b0:	cbc50513          	addi	a0,a0,-836 # 80007568 <etext+0x568>
...
write_head(void)
{
  ...
  struct buf *buf = bread(log.dev, log.start);
    800038f6:	0001f917          	auipc	s2,0x1f
    800038fa:	a6a90913          	addi	s2,s2,-1430 # 80022360 <log>
    800038fe:	01892583          	lw	a1,24(s2)
    80003902:	02892503          	lw	a0,40(s2)
    80003906:	9a0ff0ef          	jal	80002aa6 <bread>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003916:	0001f717          	auipc	a4,0x1f
    8000391a:	a7a70713          	addi	a4,a4,-1414 # 80022390 <log+0x30>
  ...
  bwrite(buf);
    ...
    80003932:	a4aff0ef          	jal	80002b7c <bwrite>
  brelse(buf);
    80003936:	8526                	mv	a0,s1
    80003938:	a76ff0ef          	jal	80002bae <brelse>
}
...
0000000080003948 <install_trans>:
  for (tail = 0; tail < log.lh.n; tail++) {
    80003948:	0001f797          	auipc	a5,0x1f
    8000394c:	a447a783          	lw	a5,-1468(a5) # 8002238c <log+0x2c>
    80003950:	08f05f63          	blez	a5,800039ee <install_trans+0xa6>
{
    ...
    8000396a:	0001fa97          	auipc	s5,0x1f
    8000396e:	a26a8a93          	addi	s5,s5,-1498 # 80022390 <log+0x30>
  for (tail = 0; tail < log.lh.n; tail++) {
    80003972:	4a01                	li	s4,0
    struct buf *lbuf = bread(log.dev, log.start+tail+1); // read log block
    80003974:	0001f997          	auipc	s3,0x1f
    80003978:	9ec98993          	addi	s3,s3,-1556 # 80022360 <log>
    8000397c:	a829                	j	80003996 <install_trans+0x4e>
    brelse(lbuf);
    8000397e:	854a                	mv	a0,s2
    80003980:	a2eff0ef          	jal	80002bae <brelse>
    brelse(dbuf);
    80003984:	8526                	mv	a0,s1
    80003986:	a28ff0ef          	jal	80002bae <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
...
00000000800039f0 <initlog>:
{
  ...
  initlock(&log.lock, "log");
    80003a02:	0001f497          	auipc	s1,0x1f
    80003a06:	95e48493          	addi	s1,s1,-1698 # 80022360 <log>
    80003a0a:	00004597          	auipc	a1,0x4
    80003a0e:	b6e58593          	addi	a1,a1,-1170 # 80007578 <etext+0x578>
  ...
  struct buf *buf = bread(log.dev, log.start);
    ...
    80003a2a:	87cff0ef          	jal	80002aa6 <bread>
  log.lh.n = lh->n;
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003a38:	0001f717          	auipc	a4,0x1f
    80003a3c:	95870713          	addi	a4,a4,-1704 # 80022390 <log+0x30>
  ...
  brelse(buf);
    80003a50:	95eff0ef          	jal	80002bae <brelse>
...
recover_from_log(void)
{
  ...
  log.lh.n = 0;
    ...
    80003a5e:	9207a923          	sw	zero,-1742(a5) # 8002238c <log+0x2c>
...
begin_op(void)
{
  ...
  acquire(&log.lock);
    ...
    80003a84:	8e050513          	addi	a0,a0,-1824 # 80022360 <log>
    80003a88:	96cfd0ef          	jal	80000bf4 <acquire>
  while(1){
    if(log.committing){
    80003a8c:	0001f497          	auipc	s1,0x1f
    80003a90:	8d448493          	addi	s1,s1,-1836 # 80022360 <log>
      sleep(&log, &log.lock);
    ...
    80003ac2:	bff9                	j	80003aa0 <begin_op+0x2c>
      ...
      log.outstanding += 1;
    80003ac4:	0001f517          	auipc	a0,0x1f
    80003ac8:	89c50513          	addi	a0,a0,-1892 # 80022360 <log>
...
end_op(void)
{
  ...
  acquire(&log.lock);
    80003aea:	0001f497          	auipc	s1,0x1f
    80003aee:	87648493          	addi	s1,s1,-1930 # 80022360 <log>
  ...
  if(log.outstanding == 0){
    ...
    80003b0e:	85648493          	addi	s1,s1,-1962 # 80022360 <log>
...
commit()
{
  if (log.lh.n > 0) {
    ...
    acquire(&log.lock);
    80003b22:	0001f497          	auipc	s1,0x1f
    80003b26:	83e48493          	addi	s1,s1,-1986 # 80022360 <log>
    ...
    80003b4c:	a3850513          	addi	a0,a0,-1480 # 80007580 <etext+0x580>
    80003b50:	c45fc0ef          	jal	80000794 <panic>
    wakeup(&log);
    80003b54:	0001f497          	auipc	s1,0x1f
    80003b58:	80c48493          	addi	s1,s1,-2036 # 80022360 <log>
  ...
  for (tail = 0; tail < log.lh.n; tail++) {
    80003b7a:	0001fa97          	auipc	s5,0x1f
    80003b7e:	816a8a93          	addi	s5,s5,-2026 # 80022390 <log+0x30>
    struct buf *to = bread(log.dev, log.start+tail+1); // log block
    80003b82:	0001ea17          	auipc	s4,0x1e
    80003b86:	7dea0a13          	addi	s4,s4,2014 # 80022360 <log>
    80003b8a:	018a2583          	lw	a1,24(s4)
    80003b8e:	012585bb          	addw	a1,a1,s2
    80003b92:	2585                	addiw	a1,a1,1
    80003b94:	028a2503          	lw	a0,40(s4)
    80003b98:	f0ffe0ef          	jal	80002aa6 <bread>
    80003b9c:	84aa                	mv	s1,a0
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
    80003b9e:	000aa583          	lw	a1,0(s5)
    80003ba2:	028a2503          	lw	a0,40(s4)
    80003ba6:	f01fe0ef          	jal	80002aa6 <bread>
    ...
    80003bbe:	fbffe0ef          	jal	80002b7c <bwrite>
    brelse(from);
    80003bc2:	854e                	mv	a0,s3
    80003bc4:	febfe0ef          	jal	80002bae <brelse>
    brelse(to);
    80003bc8:	8526                	mv	a0,s1
    80003bca:	fe5fe0ef          	jal	80002bae <brelse>
  for (tail = 0; tail < log.lh.n; tail++) {
    ...
    80003be8:	7a07a423          	sw	zero,1960(a5) # 8002238c <log+0x2c>
...
log_write(struct buf *b)
{
  ...
  acquire(&log.lock);
    80003c06:	0001e917          	auipc	s2,0x1e
    80003c0a:	75a90913          	addi	s2,s2,1882 # 80022360 <log>
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    ...
    80003c1e:	0001e797          	auipc	a5,0x1e
    80003c22:	75e7a783          	lw	a5,1886(a5) # 8002237c <log+0x1c>
    80003c26:	37fd                	addiw	a5,a5,-1
    80003c28:	04f65c63          	bge	a2,a5,80003c80 <log_write+0x88>
    panic("too big a transaction");
  if (log.outstanding < 1)
    80003c2c:	0001e797          	auipc	a5,0x1e
    80003c30:	7547a783          	lw	a5,1876(a5) # 80022380 <log+0x20>
  ...
  for (i = 0; i < log.lh.n; i++) {
    ...
    80003c40:	0001e717          	auipc	a4,0x1e
    80003c44:	75070713          	addi	a4,a4,1872 # 80022390 <log+0x30>
  for (i = 0; i < log.lh.n; i++) {
  ...
  log.lh.block[i] = b->blockno;
    ...
    80003c5c:	0001e797          	auipc	a5,0x1e
    80003c60:	70478793          	addi	a5,a5,1796 # 80022360 <log>
  ...
  if (i == log.lh.n) {  // Add new block to log?
    ...
    80003c6c:	fcbfe0ef          	jal	80002c36 <bpin>
    log.lh.n++;
    80003c70:	0001e717          	auipc	a4,0x1e
    80003c74:	6f070713          	addi	a4,a4,1776 # 80022360 <log>
    ...
    80003c84:	91050513          	addi	a0,a0,-1776 # 80007590 <etext+0x590>
    80003c88:	b0dfc0ef          	jal	80000794 <panic>
    panic("log_write outside of trans");
    80003c8c:	00004517          	auipc	a0,0x4
    80003c90:	91c50513          	addi	a0,a0,-1764 # 800075a8 <etext+0x5a8>
  ...
  log.lh.block[i] = b->blockno;
    ...
    80003ca2:	6c270713          	addi	a4,a4,1730 # 80022360 <log>
  ...
  release(&log.lock);
    ...
    80003cb4:	6b050513          	addi	a0,a0,1712 # 80022360 <log>
...
initsleeplock(struct sleeplock *lk, char *name)
{
  ...
  initlock(&lk->lk, "sleep lock");
    ...
    80003cdc:	8f058593          	addi	a1,a1,-1808 # 800075c8 <etext+0x5c8>
...
fileinit(void)
{
  ...
  initlock(&ftable.lock, "ftable");
    80003dce:	00004597          	auipc	a1,0x4
    80003dd2:	80a58593          	addi	a1,a1,-2038 # 800075d8 <etext+0x5d8>
    80003dd6:	0001e517          	auipc	a0,0x1e
    80003dda:	6d250513          	addi	a0,a0,1746 # 800224a8 <ftable>
...
filealloc(void)
{
  ...
  acquire(&ftable.lock);
    80003df4:	0001e517          	auipc	a0,0x1e
    80003df8:	6b450513          	addi	a0,a0,1716 # 800224a8 <ftable>
    80003dfc:	df9fc0ef          	jal	80000bf4 <acquire>
  for(f = ftable.file; f < ftable.file + NFILE; f++){
    80003e00:	0001e497          	auipc	s1,0x1e
    80003e04:	6c048493          	addi	s1,s1,1728 # 800224c0 <ftable+0x18>
    80003e08:	0001f717          	auipc	a4,0x1f
    80003e0c:	65870713          	addi	a4,a4,1624 # 80023460 <disk>
    if(f->ref == 0){
  ...
  release(&ftable.lock);
    80003e1c:	0001e517          	auipc	a0,0x1e
    80003e20:	68c50513          	addi	a0,a0,1676 # 800224a8 <ftable>
  ...
  return 0;
    ...
    80003e34:	67850513          	addi	a0,a0,1656 # 800224a8 <ftable>
...
filedup(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003e58:	65450513          	addi	a0,a0,1620 # 800224a8 <ftable>
  ...
  release(&ftable.lock);
    80003e6a:	0001e517          	auipc	a0,0x1e
    80003e6e:	63e50513          	addi	a0,a0,1598 # 800224a8 <ftable>
  ...
  return f;
    ...
    80003e86:	75e50513          	addi	a0,a0,1886 # 800075e0 <etext+0x5e0>
...
fileclose(struct file *f)
{
  ...
  acquire(&ftable.lock);
    ...
    80003e9e:	60e50513          	addi	a0,a0,1550 # 800224a8 <ftable>
  ...
  release(&ftable.lock);
    ...
    80003edc:	5d050513          	addi	a0,a0,1488 # 800224a8 <ftable>
  ...
  if(ff.type == FD_PIPE){
    ...
    80003f08:	6e450513          	addi	a0,a0,1764 # 800075e8 <etext+0x5e8>
    80003f0c:	889fc0ef          	jal	80000794 <panic>
    release(&ftable.lock);
    80003f10:	0001e517          	auipc	a0,0x1e
    80003f14:	59850513          	addi	a0,a0,1432 # 800224a8 <ftable>
    ...
    80003f3e:	c22ff0ef          	jal	80003360 <iput>
    end_op();
...
filestat(struct file *f, uint64 addr)
{
  ...
  if(f->type == FD_INODE || f->type == FD_DEVICE){
    ...
    80003f74:	a6aff0ef          	jal	800031de <ilock>
    stati(f->ip, &st);
    80003f78:	fb840593          	addi	a1,s0,-72
    80003f7c:	6c88                	ld	a0,24(s1)
    80003f7e:	c8aff0ef          	jal	80003408 <stati>
    iunlock(f->ip);
    80003f82:	6c88                	ld	a0,24(s1)
    80003f84:	b08ff0ef          	jal	8000328c <iunlock>
...
fileread(struct file *f, uint64 addr, int n)
{
  ...
  if(f->type == FD_PIPE){
    ...
    80003fde:	a00ff0ef          	jal	800031de <ilock>
    ...
    80003fec:	c46ff0ef          	jal	80003432 <readi>
    ...
    80003ffe:	a8eff0ef          	jal	8000328c <iunlock>
  ...
  return r;
    ...
    80004036:	3d670713          	addi	a4,a4,982 # 80022408 <devsw>
    ...
    80004050:	5ac50513          	addi	a0,a0,1452 # 800075f8 <etext+0x5f8>
    ...
    80004070:	10078b63          	beqz	a5,80004186 <filewrite+0x11a>
{
  ...
  if(f->type == FD_PIPE){
    ...
    800040d4:	0001e717          	auipc	a4,0x1e
    800040d8:	33470713          	addi	a4,a4,820 # 80022408 <devsw>
    ...
    800040f4:	8eaff0ef          	jal	800031de <ilock>
    ...
    80004108:	c26ff0ef          	jal	8000352e <writei>
    ...
    80004120:	96cff0ef          	jal	8000328c <iunlock>
      end_op();
  ...
  return ret;
    ...
    8000417e:	48e50513          	addi	a0,a0,1166 # 80007608 <etext+0x608>
...
pipealloc(struct file **f0, struct file **f1)
{
  ...
  *f0 = *f1 = 0;
  ...
  initlock(&pi->lock, "pipe");
    ...
    800041e4:	43858593          	addi	a1,a1,1080 # 80007618 <etext+0x618>
...
exec(char *path, char **argv)
{
  ...
  ilock(ip);
    800044be:	d21fe0ef          	jal	800031de <ilock>
  ...
  if(readi(ip, 0, (uint64)&elf, 0, sizeof(elf)) != sizeof(elf))
    ...
    800044d0:	f63fe0ef          	jal	80003432 <readi>
 ...
 bad:
  ...
  if(ip){
    ...
    800044ee:	efbfe0ef          	jal	800033e8 <iunlockput>
    end_op();
  ...
  for(i = 0; i < sz; i += PGSIZE){
    ...
    80004552:	0d250513          	addi	a0,a0,210 # 80007620 <etext+0x620>
    ...
    80004566:	ecdfe0ef          	jal	80003432 <readi>
  ...
  for(i=0, off=elf.phoff; i<elf.phnum; i++, off+=sizeof(ph)){
    ...
    800045bc:	e77fe0ef          	jal	80003432 <readi>
  ...
  iunlockput(ip);
    ...
    8000462c:	dbdfe0ef          	jal	800033e8 <iunlockput>
  end_op();
  ...
  ustack[argc] = 0;
    ...
    800046e8:	f9078793          	addi	a5,a5,-112 # ffffffffffffef90 <end+0xffffffff7ffdb9f0>
...
create(char *path, short type, short major, short minor)
{
  ...
  ilock(dp);
    800048ba:	925fe0ef          	jal	800031de <ilock>
  ...
  if((ip = dirlookup(dp, name, 0)) != 0){
    ...
    800048d0:	b19fe0ef          	jal	800033e8 <iunlockput>
    ilock(ip);
    800048d4:	8556                	mv	a0,s5
    800048d6:	909fe0ef          	jal	800031de <ilock>
  ...
  return 0;
    ...
    80004906:	ae3fe0ef          	jal	800033e8 <iunlockput>
    return 0;
  ...
  if((ip = ialloc(dp->dev, type)) == 0){
    ...
    80004914:	f5afe0ef          	jal	8000306e <ialloc>
    80004918:	8a2a                	mv	s4,a0
    8000491a:	cd15                	beqz	a0,80004956 <create+0xc2>
  ilock(ip);
    8000491c:	8c3fe0ef          	jal	800031de <ilock>
  ip->major = major;
  ...
  iupdate(ip);
    ...
    80004930:	ffafe0ef          	jal	8000312a <iupdate>
  ...
  iunlockput(dp);
    ...
    8000494c:	a9dfe0ef          	jal	800033e8 <iunlockput>
  return ip;
    ...
    80004958:	a91fe0ef          	jal	800033e8 <iunlockput>
    return 0;
    ...
    8000496a:	cda58593          	addi	a1,a1,-806 # 80007640 <etext+0x640>
    ...
    8000497e:	cce58593          	addi	a1,a1,-818 # 80007648 <etext+0x648>
  ...
  if(dirlink(dp, name, ip->inum) < 0)
    ...
    800049aa:	f80fe0ef          	jal	8000312a <iupdate>
    800049ae:	bf71                	j	8000494a <create+0xb6>
  ip->nlink = 0;
    800049b0:	040a1523          	sh	zero,74(s4)
  iupdate(ip);
    800049b4:	8552                	mv	a0,s4
    800049b6:	f74fe0ef          	jal	8000312a <iupdate>
  iunlockput(ip);
    800049ba:	8552                	mv	a0,s4
    800049bc:	a2dfe0ef          	jal	800033e8 <iunlockput>
  iunlockput(dp);
    800049c0:	8526                	mv	a0,s1
    800049c2:	a27fe0ef          	jal	800033e8 <iunlockput>
  return 0;
...
0000000080004b26 <sys_link>:
{
  ...
  ilock(ip);
    80004b68:	e76fe0ef          	jal	800031de <ilock>
  if(ip->type == T_DIR){
  ...
  iupdate(ip);
    ...
    80004b84:	da6fe0ef          	jal	8000312a <iupdate>
  iunlock(ip);
    80004b88:	8526                	mv	a0,s1
    80004b8a:	f02fe0ef          	jal	8000328c <iunlock>
  ...
  ilock(dp);
    80004b9e:	e40fe0ef          	jal	800031de <ilock>
  ...
  iunlockput(dp);
    ...
    80004bbe:	82bfe0ef          	jal	800033e8 <iunlockput>
  iput(ip);
    80004bc2:	8526                	mv	a0,s1
    80004bc4:	f9cfe0ef          	jal	80003360 <iput>
  end_op();
  ...
  return 0;
    ...
    80004be0:	809fe0ef          	jal	800033e8 <iunlockput>
    end_op();
    ...
    80004bf0:	ff8fe0ef          	jal	800033e8 <iunlockput>
  ilock(ip);
    80004bf4:	8526                	mv	a0,s1
    80004bf6:	de8fe0ef          	jal	800031de <ilock>
  ip->nlink--;
  ...
  iupdate(ip);
    ...
    80004c06:	d24fe0ef          	jal	8000312a <iupdate>
  iunlockput(ip);
    80004c0a:	8526                	mv	a0,s1
    80004c0c:	fdcfe0ef          	jal	800033e8 <iunlockput>
  end_op();
...
0000000080004c24 <sys_unlink>:
{
  ...
  ilock(dp);
    80004c54:	d8afe0ef          	jal	800031de <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    80004c58:	00003597          	auipc	a1,0x3
    80004c5c:	9e858593          	addi	a1,a1,-1560 # 80007640 <etext+0x640>
    ...
    80004c70:	9dc58593          	addi	a1,a1,-1572 # 80007648 <etext+0x648>
  ...
  ilock(ip);
    80004c96:	d48fe0ef          	jal	800031de <ilock>
  if(ip->nlink < 1)
  ...
  if(writei(dp, 0, (uint64)&de, off, sizeof(de)) != sizeof(de))
    ...
    80004cc6:	869fe0ef          	jal	8000352e <writei>
  ...
  iunlockput(dp);
    ...
    80004cdc:	f0cfe0ef          	jal	800033e8 <iunlockput>
  ip->nlink--;
  ...
  iupdate(ip);
    ...
    80004cec:	c3efe0ef          	jal	8000312a <iupdate>
  iunlockput(ip);
    80004cf0:	854a                	mv	a0,s2
    80004cf2:	ef6fe0ef          	jal	800033e8 <iunlockput>
  end_op();
  ...
  return 0;
    ...
    80004d12:	94250513          	addi	a0,a0,-1726 # 80007650 <etext+0x650>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80004d38:	efafe0ef          	jal	80003432 <readi>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    ...
    80004d5a:	91250513          	addi	a0,a0,-1774 # 80007668 <etext+0x668>
    80004d5e:	a37fb0ef          	jal	80000794 <panic>
    80004d62:	e5ce                	sd	s3,200(sp)
    panic("unlink: writei");
    80004d64:	00003517          	auipc	a0,0x3
    80004d68:	91c50513          	addi	a0,a0,-1764 # 80007680 <etext+0x680>
  ...
  return -1;
    ...
    80004da0:	e48fe0ef          	jal	800033e8 <iunlockput>
    goto bad;
...
sys_open(void)
{
  ...
  iunlock(ip);
    ...
    80004e62:	c2afe0ef          	jal	8000328c <iunlock>
  end_op();
  ...
  return fd;
    ...
    ilock(ip);
    80004e90:	b4efe0ef          	jal	800031de <ilock>
    ...
    80004ea6:	d42fe0ef          	jal	800033e8 <iunlockput>
      end_op();
    ...
    80004ec0:	d28fe0ef          	jal	800033e8 <iunlockput>
    end_op();
    ...
    80004ed8:	d10fe0ef          	jal	800033e8 <iunlockput>
    end_op();
    ...
    80004ef8:	bd4fe0ef          	jal	800032cc <itrunc>
...
sys_mkdir(void)
{
  ...
  iunlockput(ip);
    80004f2c:	cbcfe0ef          	jal	800033e8 <iunlockput>
  end_op();
...
sys_mknod(void)
{
  ...
  iunlockput(ip);
    80004f8c:	c5cfe0ef          	jal	800033e8 <iunlockput>
  end_op();
...
sys_chdir(void)
{
  ...
  ilock(ip);
    80004fda:	a04fe0ef          	jal	800031de <ilock>
  if(ip->type != T_DIR){
  ...
  iunlock(ip);
    ...
    80004fea:	aa2fe0ef          	jal	8000328c <iunlock>
  iput(p->cwd);
    80004fee:	15093503          	ld	a0,336(s2)
    80004ff2:	b6efe0ef          	jal	80003360 <iput>
  end_op();
  ...
  return 0;
    ...
    80005018:	bd0fe0ef          	jal	800033e8 <iunlockput>
    end_op();
...
free_desc(int i)
{
  ...
  if(i >= NUM)
    ...
    panic("free_desc 1");
  if(disk.free[i])
    80005300:	0001e797          	auipc	a5,0x1e
    80005304:	16078793          	addi	a5,a5,352 # 80023460 <disk>
  ...
  disk.desc[i].addr = 0;
    ...
    80005314:	0001e797          	auipc	a5,0x1e
    80005318:	14c78793          	addi	a5,a5,332 # 80023460 <disk>
  ...
  wakeup(&disk.free[0]);
    8000533c:	0001e517          	auipc	a0,0x1e
    80005340:	13c50513          	addi	a0,a0,316 # 80023478 <disk+0x18>
    ...
    80005354:	34050513          	addi	a0,a0,832 # 80007690 <etext+0x690>
    80005358:	c3cfb0ef          	jal	80000794 <panic>
    panic("free_desc 2");
    8000535c:	00002517          	auipc	a0,0x2
    80005360:	34450513          	addi	a0,a0,836 # 800076a0 <etext+0x6a0>
...
0000000080005368 <virtio_disk_init>:
{
  ...
  initlock(&disk.vdisk_lock, "virtio_disk");
    ...
    80005378:	33c58593          	addi	a1,a1,828 # 800076b0 <etext+0x6b0>
    8000537c:	0001e517          	auipc	a0,0x1e
    80005380:	20c50513          	addi	a0,a0,524 # 80023588 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_STATUS) = status;
  ...
  features &= ~(1 << VIRTIO_RING_F_INDIRECT_DESC);
    ...
    800053e8:	75f70713          	addi	a4,a4,1887 # ffffffffc7ffe75f <end+0xffffffff47fdb1bf>
  ...
  *R(VIRTIO_MMIO_QUEUE_SEL) = 0;
  ...
  disk.desc = kalloc();
    ...
    8000543e:	02648493          	addi	s1,s1,38 # 80023460 <disk>
  ...
  if(!disk.desc || !disk.avail || !disk.used)
    ...
    80005458:	0001e717          	auipc	a4,0x1e
    8000545c:	01073703          	ld	a4,16(a4) # 80023468 <disk+0x8>
  ...
  memset(disk.avail, 0, PGSIZE);
    80005470:	0001e497          	auipc	s1,0x1e
    80005474:	ff048493          	addi	s1,s1,-16 # 80023460 <disk>
...
virtio_disk_rw(struct buf *b, int write)
{
  ...
  acquire(&disk.vdisk_lock);
    ...
    80005590:	ffc50513          	addi	a0,a0,-4 # 80023588 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    8000559a:	44a1                	li	s1,8
      disk.free[i] = 0;
    8000559c:	0001eb17          	auipc	s6,0x1e
    800055a0:	ec4b0b13          	addi	s6,s6,-316 # 80023460 <disk>
  for(int i = 0; i < 3; i++){
  ...
  while(1){
    ...
    800055a6:	0001ec17          	auipc	s8,0x1e
    800055aa:	fe2c0c13          	addi	s8,s8,-30 # 80023588 <disk+0x128>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    800055cc:	e9870713          	addi	a4,a4,-360 # 80023460 <disk>
  ...
  for(int i = 0; i < NUM; i++){
    ...
    80005604:	e7850513          	addi	a0,a0,-392 # 80023478 <disk+0x18>
  ...
  if(write)
    8000561c:	0001e797          	auipc	a5,0x1e
    80005620:	e4478793          	addi	a5,a5,-444 # 80023460 <disk>
  ...
  *R(VIRTIO_MMIO_QUEUE_NOTIFY) = 0; // value is queue number
  ...
  while(b->disk == 1) {
    ...
    800056f2:	0001e917          	auipc	s2,0x1e
    800056f6:	e9690913          	addi	s2,s2,-362 # 80023588 <disk+0x128>
  while(b->disk == 1) {
  ...
  disk.info[idx[0]].b = 0;
    ...
    8000571a:	0001e797          	auipc	a5,0x1e
    8000571e:	d4678793          	addi	a5,a5,-698 # 80023460 <disk>
    80005722:	97ba                	add	a5,a5,a4
    80005724:	0007b423          	sd	zero,8(a5)
    int flag = disk.desc[i].flags;
    80005728:	0001e997          	auipc	s3,0x1e
    8000572c:	d3898993          	addi	s3,s3,-712 # 80023460 <disk>
  ...
  release(&disk.vdisk_lock);
    ...
    80005750:	e3c50513          	addi	a0,a0,-452 # 80023588 <disk+0x128>
...
virtio_disk_intr()
{
  ...
  acquire(&disk.vdisk_lock);
    8000577c:	0001e497          	auipc	s1,0x1e
    80005780:	ce448493          	addi	s1,s1,-796 # 80023460 <disk>
    80005784:	0001e517          	auipc	a0,0x1e
    80005788:	e0450513          	addi	a0,a0,-508 # 80023588 <disk+0x128>
  ...
  *R(VIRTIO_MMIO_INTERRUPT_ACK) = *R(VIRTIO_MMIO_INTERRUPT_STATUS) & 0x3;
  ...
  release(&disk.vdisk_lock);
    800057f8:	0001e517          	auipc	a0,0x1e
    800057fc:	d9050513          	addi	a0,a0,-624 # 80023588 <disk+0x128>
    ...
    80005812:	f6a50513          	addi	a0,a0,-150 # 80007778 <etext+0x778>
