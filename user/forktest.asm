...
forktest(void)
{
  ...
  36:	3b650513          	addi	a0,a0,950 # 3e8 <hello+0x8>
  ...
  58:	3e450513          	addi	a0,a0,996 # 438 <hello+0x58>
  ...
  6e:	38e50513          	addi	a0,a0,910 # 3f8 <hello+0x18>
  ...
  80:	39450513          	addi	a0,a0,916 # 410 <hello+0x30>
  ...
  b0:	37c50513          	addi	a0,a0,892 # 428 <hello+0x48>
